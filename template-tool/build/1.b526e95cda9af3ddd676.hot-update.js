...
const TemplateList = () => {
  ...
  return __jsx("div", {
    ...
    className: "border-0 rounded-md px-4 py-1 h-10 " + ((categoryFilter === null || categoryFilter === void 0 ? void 0 : categoryFilter.id) === cat.id ? "text-white bg-indigo700" : "bg-lightindigo text-indigo700 "),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=1.b526e95cda9af3ddd676.hot-update.js.map