...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
 ...
 // import { templateData.stageDimensions } from '../../../utils/defaults';
...
const MainStage = ({
  ...
  const getLineGuideStops = skipShape => {
    ...
    const vertical = [0, templateData.stageDimensions.width / 2, templateData.stageDimensions.width];
    const horizontal = [0, templateData.stageDimensions.height / 2, templateData.stageDimensions.height]; // we snap over edges and center of each object on the canvas
  ...
  return __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Stage"], {
    ...
    ,
    width: 1920,
    height: 240 // {...templateData.stageDimensions}
    ,
    __self: undefined,
    __source: {
...
//# sourceMappingURL=0.641ef3a08a9c9c99c2a5.hot-update.js.map