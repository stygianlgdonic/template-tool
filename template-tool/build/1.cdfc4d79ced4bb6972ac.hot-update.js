...
const TemplateList = () => {
  ...
  return __jsx("div", {
    ...
    className: "bg-lightindigo text-indigo700 rounded-md px-4 py-1 h-10 " + ((categoryFilter === null || categoryFilter === void 0 ? void 0 : categoryFilter.id) === cat.id ? "text-white bg-indigo700" : ""),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=1.cdfc4d79ced4bb6972ac.hot-update.js.map