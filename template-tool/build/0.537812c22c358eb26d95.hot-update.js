...
const MainStage = ({
  ...
  const getLineGuideStops = skipShape => {
    ...
    const vertical = [0, templateData.dimensions.width * 0.5 / 2, templateData.dimensions.width * 0.5];
    const horizontal = [0, templateData.dimensions.height * 0.5 / 2, templateData.dimensions.height * 0.5]; // we snap over edges and center of each object on the canvas
  ...
  return __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Stage"], {
    ...
    // onClick={onClickTap}
    ,
    width: templateData.dimensions.width * 0.5,
    height: templateData.dimensions.height * 0.5,
    __self: undefined,
    __source: {
...
//# sourceMappingURL=0.537812c22c358eb26d95.hot-update.js.map