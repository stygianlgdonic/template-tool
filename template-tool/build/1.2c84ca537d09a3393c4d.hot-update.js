...
const TemplateList = () => {
  ...
  return __jsx("div", {
    ...
    className: "outline-none rounded-md px-4 py-1 h-10 " + ((categoryFilter === null || categoryFilter === void 0 ? void 0 : categoryFilter.id) === cat.id ? "text-white bg-indigo700" : "bg-lightindigo text-indigo700 "),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=1.2c84ca537d09a3393c4d.hot-update.js.map