...
const CategoryList = () => {
  ...
  return __jsx("div", {
    ...
    className: "bg-gray900 hover:bg-bluish text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline",
    type: "button",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=1.b2fdfeeec1a80d71a3b2.hot-update.js.map