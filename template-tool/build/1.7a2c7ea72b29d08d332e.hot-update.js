...
const CategoryList = () => {
  ...
  return __jsx("div", {
  ...
  }, categoriesList === null || categoriesList === void 0 ? void 0 : categoriesList.map((cat, index) => {
    __jsx("span", {
      key: index,
      className: "block",
      __self: undefined,
    ...
    className: "bg-gray900 hover:bg-lightGray text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline",
    type: "button",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=1.7a2c7ea72b29d08d332e.hot-update.js.map