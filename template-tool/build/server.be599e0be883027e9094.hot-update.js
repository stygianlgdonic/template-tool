...
const HomeSideBar = () => {
  ...
  return __jsx("div", {
    ...
    className: "block flex items-center  hover:bg-rightbackgroundcolor  w-full hover:rounded-lg border-0 rounded-sm  pl-5 h-10 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
...
//# sourceMappingURL=server.be599e0be883027e9094.hot-update.js.map