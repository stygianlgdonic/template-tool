...
const addNewTemplate = async templateData => {
  ...
  const response = await fetch(`https://polar-tor-04971.herokuapp.com/template`, {
    method: "POST",
    body: JSON.stringify(_objectSpread(_objectSpread({}, templateData), {}, {
      id: "testgrad1"
    }))
  });
  console.log({
  ...
  console.log({
    responsejson: response === null || response === void 0 ? void 0 : response.json()
  });
...
//# sourceMappingURL=server.bb9a6f0a78e352567543.hot-update.js.map