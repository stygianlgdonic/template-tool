...
const DesignTool = () => {
  const addNewTemplateMutation = Object(react_query__WEBPACK_IMPORTED_MODULE_14__["useMutation"])(_services_templateService__WEBPACK_IMPORTED_MODULE_13__["addNewTemplate"]);
  const {
    0: variationIndex,
    1: setVariationIndex
  ...
  const handleSaveTemplate = (tagsList, selectedCategory) => {
    console.log({
      tagsList,
      selectedCategory
    }); // TODO - handle crud into db here

    addNewTemplateMutation(_objectSpread(_objectSpread({}, templateData), {}, {
      tagsList
    }));
...
//# sourceMappingURL=0.9cd704f2e6ebb4e92ee6.hot-update.js.map