...
const Home = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex w-full bg-bluish justify-between text-gray-700 hover:text-gray-900 cursor-pointer items-center mb-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
...
//# sourceMappingURL=server.0eedec93b1fc5b14705b.hot-update.js.map