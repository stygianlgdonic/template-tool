...
const CategoryList = () => {
  ...
  const handleDeleteCategory = async cat => {
    sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
      ...
      if (willDelete) {
        const res = await _services_categoryService__WEBPACK_IMPORTED_MODULE_2__["category_service"].deleteCategoryByID(cat.id);
        console.log({
          res
        });
      }
...
//# sourceMappingURL=1.33236a5f91b33b772daf.hot-update.js.map