...
/* harmony import */ var _hooks_useAllTemplates__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../hooks/useAllTemplates */ "./src/hooks/useAllTemplates.ts");
...
const TemplateList = () => {
  const {
    ...
    error,
    isLoading
  } = Object(_hooks_useAllTemplates__WEBPACK_IMPORTED_MODULE_3__["default"])();
  console.log({
    data
  });
...
const useAllTemplates = () => {
  const {
    ...
    error,
    isLoading
  } = Object(react_query__WEBPACK_IMPORTED_MODULE_0__["useQuery"])("templates", _services_templateService__WEBPACK_IMPORTED_MODULE_1__["getAllTemplates"]);
  return {
    data,
    error,
    isLoading
...
/* harmony default export */ __webpack_exports__["default"] = (useAllTemplates);

/***/ })

};
//# sourceMappingURL=1.943fd474d265e2080cf9.hot-update.js.map