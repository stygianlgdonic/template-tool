...
const TemplateList = () => {
  ...
  return __jsx("div", {
    ...
    className: " ml-auto bg-bluish flex mt-1 mr-1 items-center rounded-full  text-black   text-sm leading-none font-semibold outline-none focus:outline-none" // onClick={() => setShowModal(false)}
    ,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.f418865fdf0cff3bc1bf.hot-update.js.map