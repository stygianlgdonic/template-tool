...
const DesignTool = () => {
  ...
  const {
    ...
    error,
    isLoading
  } = Object(react_query__WEBPACK_IMPORTED_MODULE_14__["useQuery"])("currentTemplate", Object(_services_templateService__WEBPACK_IMPORTED_MODULE_13__["getTemplateByID"])(templateID));
  setTemplateData(data); // const addNewTemplateMutation = useMutation(addNewTemplate)
  ...
  const handleSaveTemplate = (tags, selectedCategory) => {
    ...
    if (!!templateData.id) {
      Object(_services_templateService__WEBPACK_IMPORTED_MODULE_13__["updateTemplateByID"])(templateData.id, templateData);
    } else {
...
//# sourceMappingURL=0.2c35edad4d1aa734e6d4.hot-update.js.map