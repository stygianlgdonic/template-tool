...
const Home = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex w-full bg-gray300 justify-between text-gray-700 hover:text-gray-900 cursor-pointer items-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
...
//# sourceMappingURL=server.23f5463c1517b833216e.hot-update.js.map