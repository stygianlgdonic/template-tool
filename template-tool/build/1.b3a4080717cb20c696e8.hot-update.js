...
const TemplateList = () => {
  ...
  return __jsx("div", {
    ...
    className: "bg-lightindigo text-indigo700 rounded-md px-4 py-1 h-10 " + (categoryFilter.id === cat.id ? "text-green" : ""),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=1.b3a4080717cb20c696e8.hot-update.js.map