...
const UCircle = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
    ...
    strokeScaleEnabled: false,
    onTransformEnd: e => {
      onChange(_objectSpread({}, e.target.attrs));
    },
    onDragEnd: e => {
      onChange(_objectSpread(_objectSpread({}, shapeProps), {}, {
        x: e.target.x(),
...
const UPolygon = ({
  ...
  console.log({
    imageWidth,
    imageHeight,
    offset: shapeRef === null || shapeRef === void 0 ? void 0 : (_shapeRef$current = shapeRef.current) === null || _shapeRef$current === void 0 ? void 0 : _shapeRef$current.fillPatternOffset(),
    scale: shapeRef === null || shapeRef === void 0 ? void 0 : (_shapeRef$current2 = shapeRef.current) === null || _shapeRef$current2 === void 0 ? void 0 : _shapeRef$current2.fillPatternScale()
