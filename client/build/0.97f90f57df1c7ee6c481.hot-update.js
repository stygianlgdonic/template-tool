...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex items-center bg-white hover:bg-rightbackgroundcolor active:bg-rightbackgroundcolor w-full hover:rounded-lg border-0 rounded-sm  pl-5 mb-1 h-10 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12,
...
//# sourceMappingURL=0.97f90f57df1c7ee6c481.hot-update.js.map