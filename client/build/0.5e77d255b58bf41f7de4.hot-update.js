...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " absolute inline-block align-bottom bg-white rounded-lg px-4 justify-center pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 333,
    ...
    className: "w-full flex gap-4 justify-center w-40",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 335,
...
//# sourceMappingURL=0.5e77d255b58bf41f7de4.hot-update.js.map