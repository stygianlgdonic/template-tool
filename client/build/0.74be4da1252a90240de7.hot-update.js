...
const TextHeader = ({
  ...
  const [values, setValues] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState([100]);
  const {
    handleFontStyle,
    handleTextAlign,
    handleTextOpacity,
  ...
  return __jsx("div", {
    ...
    className: "ml-6 text-lg italic font-bold text-black hover:bg-lightindigo px-3 py-1 rounded focus:ring-2 ring-indigo600 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 192,
...
//# sourceMappingURL=0.74be4da1252a90240de7.hot-update.js.map