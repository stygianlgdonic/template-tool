...
const Stickers = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch('https://reserve.freesvg.org/api/v1/svgs').then(res => res).then(res => console.log(res)).catch(err => console.log(err));
  }, []);
...
//# sourceMappingURL=0.c19869d0ee95015fff5d.hot-update.js.map