...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-96 hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.4ea1e4f76a0f04ead9ca.hot-update.js.map