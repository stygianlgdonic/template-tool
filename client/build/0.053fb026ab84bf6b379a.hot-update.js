...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-72 z-10 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1  bg-yellow  relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " h-28 z-50 -mr-12 bg-red bg-opacity-100 to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
...
//# sourceMappingURL=0.053fb026ab84bf6b379a.hot-update.js.map