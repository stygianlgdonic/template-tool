...
const CustomColorPicker = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ref: myRef,
    className: " border border-green fixed z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none",
    __self: undefined,
    __source: {
    ...
    className: "relative w-auto max-w-3xl mx-auto p-5",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
...
//# sourceMappingURL=0.0849c80d8f01373a6e2d.hot-update.js.map