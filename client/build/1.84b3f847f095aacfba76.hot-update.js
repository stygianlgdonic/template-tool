...
const RightSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-center bg-green items-center mb-4",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55,
    ...
    className: dashboardnavigator === "images" && sidebarnavigator === "stat" ? "bg-yellow" : "hidden",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=1.84b3f847f095aacfba76.hot-update.js.map