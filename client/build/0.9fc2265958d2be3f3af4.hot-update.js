...
const ElementHeader = () => {
  ...
  const {} = Object(_contexts_DesignTool_SubnavbarActions__WEBPACK_IMPORTED_MODULE_2__["default"])();
  return __jsx("div", {
...
const SubNavbarActions = () => {
  ...
  const selectTextToolSubNav = () => {
    designToolDispatch({
      type: "Select_Texttool_Sub_Nav"
    });
  };

  const selectFontToolSubNav = () => {
    designToolDispatch({
      type: "Select_Fonttool_Sub_Nav"
    });
  };

  const selectEffectToolSubNav = () => {
    designToolDispatch({
      type: "Select_Effecttool_Sub_Nav"
    });
  };
...
//# sourceMappingURL=0.9fc2265958d2be3f3af4.hot-update.js.map