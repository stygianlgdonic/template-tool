...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " fixed overflow-y-auto no-scrollbar z-50  flex-grow  bg-gray900  inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0 translate-y-16  " : " transition-all delay-500  translate-x-full "),
    __self: this,
    __source: {
...
//# sourceMappingURL=0.f6d4f836487aa57d7d51.hot-update.js.map