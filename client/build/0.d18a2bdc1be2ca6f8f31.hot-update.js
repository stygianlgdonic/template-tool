...
const Stickers = () => {
  ...
  return __jsx("div", {
    className: "h-full flex  flex-col bg-radicalRed",
    __self: undefined,
    __source: {
    ...
    className: "flex flex-row mt-4 gap-4 h-28 overflow-x-scroll justify-between flex-shrink-0 overflow-hidden  no-scrollbar",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "flex flex-row mt-4 gap-4 h-28 overflow-x-scroll flex-shrink-0 overflow-hidden px-4 no-scrollbar",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.d18a2bdc1be2ca6f8f31.hot-update.js.map