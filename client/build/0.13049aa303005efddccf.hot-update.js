...
const TextSelector = () => {
  return __jsx("div", {
    ...
    className: "text-sm  hover:font-bold font-normal flex items-center w-32 h-9",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "hover:bg-indigo100 px-2  border-2 border-bordercolor  mt-4 rounded-md mr-4",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
...
//# sourceMappingURL=0.13049aa303005efddccf.hot-update.js.map