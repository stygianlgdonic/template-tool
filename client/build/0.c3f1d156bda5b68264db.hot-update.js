...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl top-28 transform transition-all right-14  self-end",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.c3f1d156bda5b68264db.hot-update.js.map