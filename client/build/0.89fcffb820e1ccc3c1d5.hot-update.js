...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl top-32 transform transition-all left-600  self-end",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.89fcffb820e1ccc3c1d5.hot-update.js.map