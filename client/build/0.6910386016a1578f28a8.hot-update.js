...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: " h-28 z-10 -mr-10 bg-gradient-to-r w-10 from-gray95  to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-72 z-50 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1    relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.6910386016a1578f28a8.hot-update.js.map