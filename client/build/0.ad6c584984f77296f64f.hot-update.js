...
const AddLogoImageModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ref: myRef,
    className: "relative z-50 flex items-center justify-center m-auto overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-radicalpinkish",
    __self: undefined,
    __source: {
    ...
    className: "absolute py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg top-72 z-999 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
...
//# sourceMappingURL=0.ad6c584984f77296f64f.hot-update.js.map