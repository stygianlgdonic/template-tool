...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 py-2 pl-3 pr-10 ml-2 text-left bg-white border border-gray-300 rounded-md shadow-sm cursor-default h-7 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm",
    ...
    className: "relative z-10 p-3 text-xs leading-none text-white whitespace-no-wrap rounded-md shadow-lg bg-indigo500",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 271,
    ...
    className: "z-50 flex justify-end w-3 h-3 -mt-2 transform rotate-45 bg-red",
    style: {
      marginLeft: "94px"
    },
    __self: undefined,
...
//# sourceMappingURL=0.1c959b055d00ee423f38.hot-update.js.map