...
const Buttons = () => {
  return __jsx("div", {
    ...
    className: "bg-fuschia text-white flex flex-row w-40 justify-center h-12 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
    ...
    className: "bg-bluish text-white flex flex-row w-40 justify-center h-12 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row mt-4  h-28 overflow-x-scroll flex-shrink-0",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
...
const DesignTool = () => {
  return __jsx("div", {
    className: "w-full grid grid-cols-12 font-inter max-h-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
    ...
    className: "col-span-2 w-full border-bordercolor border-r-2 bg-redish",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
    ...
    className: "col-span-3 h-full w-full  bg-yellowish",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
    ...
    className: "col-span-7 h-full bg-greenish ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
...
//# sourceMappingURL=0.3e82b768fad385c81021.hot-update.js.map