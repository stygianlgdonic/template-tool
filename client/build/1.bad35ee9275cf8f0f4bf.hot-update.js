...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex items-start justify-between w-full pl-5 pb-3 pt-2 border-b border-solid rounded-t border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 200,
    ...
    className: "border-b border-solid border-bordercolor top-0 bg-deletebuttontext flex items-start ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 215,
...
//# sourceMappingURL=1.bad35ee9275cf8f0f4bf.hot-update.js.map