...
const MainStage = ({
  ...
  const _onDragMove = e => {
    ...
    const itemBounds = getObjectSnappingEdges(e.target); // const itemBounds = getObjectSnappingEdges(e.target);
...
//# sourceMappingURL=0.13a7fc51c6ca17737e5a.hot-update.js.map