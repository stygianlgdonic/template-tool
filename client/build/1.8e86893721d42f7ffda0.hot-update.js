...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "relative   my-6 z-50 mx-auto max-w-4xl bg-white",
    style: {
      height: '85vh'
    },
    __self: undefined,
    ...
    className: " rounded-md border-bordercolor justify-center items-center flex flex-col py-2 bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 132,
...
//# sourceMappingURL=1.8e86893721d42f7ffda0.hot-update.js.map