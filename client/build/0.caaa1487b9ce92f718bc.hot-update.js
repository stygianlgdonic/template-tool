...
const BackgroundColor = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "w-24 font-inter h-9 inline-flex items-center px-3 py-1.5 border-2 border-bordercolor text-xs font-medium rounded-md shadow-sm text-gradientColor bg-jacksonsGray hover:bg-jacksonsGray focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jacksonsGray",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=0.caaa1487b9ce92f718bc.hot-update.js.map