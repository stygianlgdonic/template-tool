...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "relative w-screen max-w-full pb-10 flex flex-col h-full overflow-y-scroll  border-4 border-black ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "h-full flex border-4 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
...
//# sourceMappingURL=0.87fdf5568eff49547608.hot-update.js.map