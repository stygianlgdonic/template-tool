...
const MainStage = ({
  ...
  const onMouseUp = () => {
    oldPos.current = null;
    console.log("selection.current.visible: ", selection.current.visible);
  ...
  return __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Stage"], _extends({
    ...
    ref: selection // selectionRectRef
    ,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.c664712eac042a90f422.hot-update.js.map