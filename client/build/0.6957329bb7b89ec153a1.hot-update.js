...
const TextHeader = ({
  ...
  const handleChangeFontStyle = () => {
    var _selectedText$fontSty;

    console.log({
      Style: (_selectedText$fontSty = selectedText.fontStyle) === null || _selectedText$fontSty === void 0 ? void 0 : _selectedText$fontSty.contains("bold")
    });
    handleFontStyle(selectedText.fontStyle === "italic" ? "normal" : "italic");
  };
...
//# sourceMappingURL=0.6957329bb7b89ec153a1.hot-update.js.map