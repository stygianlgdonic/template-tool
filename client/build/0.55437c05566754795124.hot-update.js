...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative flex flex-row  items-center  py-2 px-4 text-left border-2 rounded-lg shadow-sm  h-10 border-bordercolor hover:lightindigo focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.55437c05566754795124.hot-update.js.map