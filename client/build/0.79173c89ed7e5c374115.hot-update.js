...
const MainStage = ({
  ...
  const onClickTap = e => {
    ...
    const isBackground = ((_e$target$attrs = e.target.attrs) === null || _e$target$attrs === void 0 ? void 0 : _e$target$attrs.id) === "shapes_background"; // if we are selecting with rect, do nothing
...
//# sourceMappingURL=0.79173c89ed7e5c374115.hot-update.js.map