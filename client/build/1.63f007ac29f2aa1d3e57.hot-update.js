...
const ImagePreview = ({
  ...
  return __jsx("div", {
    className: "mt-4 overflow-y-auto overscroll-y-auto w-full  flex self-center  justify-center border px-6 rounded-lg pb-10 shadow-md",
    __self: undefined,
    __source: {
    ...
    className: "flex flex-row justify-center mt-4 px-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: "flex flex-row border-2 px-2 py-1 rounded-md items-center text-sm text-gray94 border-bordercolor shadow-md ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 36,
    ...
    className: "flex flex-row border-2 px-2 py-1 rounded-md items-center text-gray94 text-sm border-bordercolor shadow-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
    ...
    className: " flex justify-center border-t border-gallery mt-4 mb-4 w-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
...
//# sourceMappingURL=1.63f007ac29f2aa1d3e57.hot-update.js.map