...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col items-center justify-center py-4 border-2 border-solid rounded-md border-bordercolor ",
    onClick: () => {
      setNewModal(true);
      setShowModal(false);
    },
...
//# sourceMappingURL=1.ee96fba551c2fa67b44b.hot-update.js.map