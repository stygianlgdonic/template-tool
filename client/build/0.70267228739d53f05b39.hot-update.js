...
const TextHeader = ({
  ...
  var _fontSizeArray$find, _selectedText$fontSty, _selectedText$fontSty2, _selectedText$align, _selectedText$align2, _selectedText$align3;
  ...
  return __jsx("div", {
    ...
    className: "ml-6  rounded-md hover:bg-lightindigo h-10 w-10 pl-2  " + (showModal ? "border-2 border-indigo600" : ""),
    ...
    className: "hover:bg-lightindigo px-2 my-2 h-10 rounded-md w-10 flex  items-center justify-center" + (selectedText !== null && selectedText !== void 0 && (_selectedText$align = selectedText.align) !== null && _selectedText$align !== void 0 && _selectedText$align.includes("left") ? " bg-lightindigo" : ""),
    ...
    className: "hover:bg-lightindigo px-2 my-2 h-10 rounded-md w-10 flex items-center justify-center" + (selectedText !== null && selectedText !== void 0 && (_selectedText$align2 = selectedText.align) !== null && _selectedText$align2 !== void 0 && _selectedText$align2.includes("center") ? " bg-lightindigo" : ""),
    ...
    className: "hover:bg-lightindigo px-2 my-2 h-10 rounded-md w-10 flex items-center justify-center" + (selectedText !== null && selectedText !== void 0 && (_selectedText$align3 = selectedText.align) !== null && _selectedText$align3 !== void 0 && _selectedText$align3.includes("right") ? " bg-lightindigo" : ""),
...
//# sourceMappingURL=0.70267228739d53f05b39.hot-update.js.map