...
const DesignToolProvider = ({
  ...
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])(_DesingToolReducers__WEBPACK_IMPORTED_MODULE_3__["designToolReducer"], _DesingToolReducers__WEBPACK_IMPORTED_MODULE_3__["designToolInit"]); // const [preview, setPreview] = useState(null)
  // useEffect(() => {
  //     const url = $stage.current?.toDataURL({ pixelRatio: 1 / 2 })
  //     setPreview(url)
  // }, [cardData, selectedId])
...
//# sourceMappingURL=server.0b3cd8b1832281c60739.hot-update.js.map