...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: showeModal ? "ml-6  hover:bg-lightindigo h-10 w-10 pl-2 rounded-md focus:border-2 border-indigo600 " : "ml-6  hover:bg-lightindigo h-10 w-10 pl-2 rounded-md  ",
    onClick: () => {
      seteShowModal(true);
...
//# sourceMappingURL=0.8c92c1e26eaeb27d4282.hot-update.js.map