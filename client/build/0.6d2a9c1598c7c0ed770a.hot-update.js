...
const AddLogoImageModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ref: myRef,
    className: "fixed z-50 flex items-center justify-center w-full m-auto overflow-x-hidden overflow-y-hidden outline-none focus:outline-none",
    __self: undefined,
    __source: {
    ...
    className: "relative flex items-center justify-end w-full h-full mx-auto mt-6 mb-1 ",
...
//# sourceMappingURL=0.6d2a9c1598c7c0ed770a.hot-update.js.map