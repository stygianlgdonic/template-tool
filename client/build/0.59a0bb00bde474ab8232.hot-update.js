...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: " mt-6  mb-1 flex justify-end w-9/12 relative  items-center group mx-auto ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 69,
    ...
    className: "absolute bottom-0  flex-col items-center hidden mb-6 group-hover:flex bg-yellow ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
    ...
    className: "relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap rounded-md bg-indigo400 shadow-lg",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74,
    ...
    className: "w-3 h-3 transform rotate-45 -mt-2  flex justify-end bg-indigo400 z-50",
    style: {
      marginLeft: '120px'
    },
    __self: undefined,
...
//# sourceMappingURL=0.59a0bb00bde474ab8232.hot-update.js.map