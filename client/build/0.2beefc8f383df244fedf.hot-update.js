...
const MainStage = ({
  ...
  return __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Stage"], _extends({
  ...
  }, _utils_defaults__WEBPACK_IMPORTED_MODULE_10__["stageDimensions"], {
    __self: undefined,
    __source: {
    ...
    onMouseOver: e => {
      let shape = e.target; // console.log({ shape })

      shape.scaleX(1.2);
      shape.scaleY(1.2);
      shape.contrast(0.1);
      if (!(shape.id() === 'shapes_background')) document.body.style.cursor = 'pointer';
    },
    onMouseOut: e => {
      let shape = e.target; // console.log({ shape })
      ...
      shape.scaleX(1);
      shape.scaleY(1);
      if (!(shape.id() === 'shapes_background')) document.body.style.cursor = 'default';
    },
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.2beefc8f383df244fedf.hot-update.js.map