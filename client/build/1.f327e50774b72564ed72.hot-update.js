...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col items-center justify-center py-4 bg-blue-600 border-2 border-dashed rounded-md w-52 border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 344,
    ...
    className: "mt-1 text-sm text-lightGray bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 349,
...
//# sourceMappingURL=1.f327e50774b72564ed72.hot-update.js.map