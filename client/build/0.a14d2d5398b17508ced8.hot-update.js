...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " fixed overflow-y-auto overflow-y-scroll  flex-grow z-10 bg-gray-900 bg-opacity-25 inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0 translate-y-16  " : " transition-all delay-500 opacity-0 translate-x-full "),
    __self: this,
    __source: {
...
//# sourceMappingURL=0.a14d2d5398b17508ced8.hot-update.js.map