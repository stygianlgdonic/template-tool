...
const MainStage = ({
  ...
  return __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Stage"], _extends({
    ...
    onMouseOver: e => {
      ...
      if (!(shape.id() === 'shapes_background')) shapeOpacity.current = shape.opacity();
      shape.opacity(0.5);
    ...
    onMouseOut: e => {
      ...
      if (!(shape.id() === 'shapes_background')) shape.opacity(shapeOpacity.current);
...
//# sourceMappingURL=0.9d28cd518673dbe20772.hot-update.js.map