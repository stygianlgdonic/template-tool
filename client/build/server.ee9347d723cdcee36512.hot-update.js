...
function Example() {
  return __jsx("div", {
    ...
    href: "#",
    className: "font-medium text-indigo600 hover:text-indigo4500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68,
    ...
    type: "submit",
    className: "group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo500",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 75,
    ...
    className: "h-5 w-5 text-indigo600 group-hover:text-indigo400",
    "aria-hidden": "true",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.ee9347d723cdcee36512.hot-update.js.map