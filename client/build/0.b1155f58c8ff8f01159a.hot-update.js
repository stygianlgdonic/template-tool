...
const ElementHeader = () => {
  ...
  const {
    selectedId,
    cardData
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_contexts_DesignTool_DesignToolContext__WEBPACK_IMPORTED_MODULE_2__["DesignToolContext"]); // !!state?false:true;
  ...
  return __jsx("div", {
    ...
    className: "w-10 h-10 rounded-md hover:border-2 border-indigo600",
    style: {
...
//# sourceMappingURL=0.b1155f58c8ff8f01159a.hot-update.js.map