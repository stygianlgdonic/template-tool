...
const UCircle = ({
  ...
  const Xpoint = circleWidth / 2 - imageWidth / 2;
  const Ypoint = circleHeight / 2 - imageHeight / 2; // const patternScale = restProps.patternScale || Math.max(
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
    ...
    fillPatternImage: image // fillPatternOffset={{ x: (circleWidth / 2), y: (circleHeight / 2) }}
...
//# sourceMappingURL=0.405b816eb63ea9f95426.hot-update.js.map