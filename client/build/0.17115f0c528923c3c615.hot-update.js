...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative px-2 py-1 pl-1 pr-5 text-left bg-white border rounded-md shadow-sm cursor-default border-gray300 w-36 h-7 focus:outline-none focus:ring-1 focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
    "aria-haspopup": "listbox",
    "aria-expanded": "true",
    "aria-labelledby": "listbox-label",
    __self: undefined,
...
//# sourceMappingURL=0.17115f0c528923c3c615.hot-update.js.map