...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute w-full py-1 mt-1 overflow-auto text-base rounded-md shadow-lg z-999 bg-red max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
    "aria-activedescendant": "listbox-option-3",
    style: {
...
//# sourceMappingURL=0.e4e07b696d509004cca1.hot-update.js.map