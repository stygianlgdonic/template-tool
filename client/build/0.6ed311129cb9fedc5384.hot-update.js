...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex items-center  hover:bg-lightrightbackgroundcolor  w-full hover:rounded-lg border-0 rounded-sm  pl-5 h-10 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
    ...
    className: "flex items-center hover:bg-lightrightbackgroundcolor w-full hover:rounded-lg border-0 rounded-sm  pl-5 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
...
//# sourceMappingURL=0.6ed311129cb9fedc5384.hot-update.js.map