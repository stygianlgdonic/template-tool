...
const TextSelector = () => {
  return __jsx("div", {
    ...
    className: "  gap-4 grid md:grid-cols-2 2xl:grid-cols-2 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
    ...
    className: "text-sm  hover:font-bold font-normal flex items-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "hover:bg-indigo100 px-2  border-2 border-bordercolor w-32 h-9 mt-4 rounded-md mr-4",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
...
//# sourceMappingURL=0.a797f0de2f38b070682e.hot-update.js.map