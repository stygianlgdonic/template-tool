...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (userObj.password === userObj.againPassword) {} else if (!!userObj.email && !!userObj.password && !!userObj.againPassword && userObj.password === userObj.againPassword) {
      console.log({
        userObj
      });
...
//# sourceMappingURL=3.1753b787451b04ff0f3a.hot-update.js.map