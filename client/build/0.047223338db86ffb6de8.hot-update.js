...
const CreateCardLayout = () => {
  ...
  return __jsx("div", {
    ...
    className: "w-10 absolute h-full right-0 top-0 z-0 bg-white",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
    ...
    className: "flex  bg-gray50 items-center h-full pt-10 z-20 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
...
//# sourceMappingURL=0.047223338db86ffb6de8.hot-update.js.map