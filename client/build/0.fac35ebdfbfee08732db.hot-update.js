...
const TextSelector = () => {
  ...
  return __jsx("div", {
    ...
    className: "text-xl leading-none font-normal text-gray94 mb-2 hover:bg-lightindigo px-4 rounded",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
    ...
    className: "text-lg leading-none font-normal text-gray94 mb-2 hover:bg-lightindigo px-4 rounded",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
...
//# sourceMappingURL=0.fac35ebdfbfee08732db.hot-update.js.map