...
const Stickers = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch('https://reserve.freesvg.org/api/v1/svgs').then(res => res.json()).then(res => console.log(res)).catch(err => console.log(err));
  }, []);
...
//# sourceMappingURL=0.03040ce711527ada250d.hot-update.js.map