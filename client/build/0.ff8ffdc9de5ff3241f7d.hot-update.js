...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: showeModal ? "ml-6  hover:bg-lightindigo h-10 w-10 pl-2 rounded-md active:ring-2 ring-indigo600 " : "ml-6  hover:bg-lightindigo h-10 w-10 pl-2 rounded-md  ",
    onClick: () => {
      seteShowModal(true);
...
//# sourceMappingURL=0.ff8ffdc9de5ff3241f7d.hot-update.js.map