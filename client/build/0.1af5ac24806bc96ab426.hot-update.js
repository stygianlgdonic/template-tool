...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative flex items-end justify-center  min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 242,
    ...
    className: "fixed inset-0  transition-opacity bg-green",
    "aria-hidden": "true",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " absolute inline-block align-bottom w-40  items-center bg-white rounded-lg px-4 justify-center overflow-hidden shadow-xl transform transition-all top-28 mt-2 right-0 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 249,
...
//# sourceMappingURL=0.1af5ac24806bc96ab426.hot-update.js.map