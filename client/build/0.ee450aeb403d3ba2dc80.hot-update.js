...
const TextHeader = ({
  ...
  return __jsx("div", {
    ...
    className: " h-10 rounded-md w-10 flex  items-center justify-center",
    ...
    className: "hover:bg-lightindigo px-2 py-2",
    width: "18",
    height: "14",
    viewBox: "0 0 18 14",
    fill: "none",
    ...
    className: "ml-6 text-lg italic font-bold text-black hover:bg-lightindigo px-3 py-1 rounded active:ring-2 ring-indigo600 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 220,
...
//# sourceMappingURL=0.ee450aeb403d3ba2dc80.hot-update.js.map