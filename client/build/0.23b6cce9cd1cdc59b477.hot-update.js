...
const UText = ({
  ...
  const handleClickOutside = e => {
    ...
    if (!((_textAreaRef$current = textAreaRef.current) !== null && _textAreaRef$current !== void 0 && _textAreaRef$current.contains(e.target))) {
      setNewTextObj(prev => {
...
//# sourceMappingURL=0.23b6cce9cd1cdc59b477.hot-update.js.map