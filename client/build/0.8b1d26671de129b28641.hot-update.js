...
const UText = ({
  ...
  const handleTextareaKeyDown = e => {
    if (e.keyCode === "Escape") {
      ...
      console.log("$tr.current.visible()", $tr.current.visible()); // textNode.current.show()
      // $tr.current.attachTo(textNode.current)
...
//# sourceMappingURL=0.8b1d26671de129b28641.hot-update.js.map