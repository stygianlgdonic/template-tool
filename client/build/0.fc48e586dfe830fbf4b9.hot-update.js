...
const BackgroundColorModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    type: "button",
    className: (fillType === false ? "bg-SolidColor text-white" : "") + " w-14 font-inter h-10 inline-flex items-center px-3 py-1.5 border-2 border-gray300 text-xs font-medium rounded-md shadow-sm text-gradientColor bg-jacksonsGray  ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
...
//# sourceMappingURL=0.fc48e586dfe830fbf4b9.hot-update.js.map