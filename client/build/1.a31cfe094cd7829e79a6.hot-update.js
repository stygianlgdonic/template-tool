...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    className: "h-full  flex flex-col  w-full pr-1 bg-yellowgreen",
    __self: undefined,
    __source: {
    ...
    className: "flex flex-col justify-start text-left items-start px-2 leading-10 text-lightGray  ml-1 ",
    style: {
      width: '33.5vh'
    },
    __self: undefined,
...
//# sourceMappingURL=1.a31cfe094cd7829e79a6.hot-update.js.map