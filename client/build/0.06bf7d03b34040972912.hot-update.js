...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    className: "fixed z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none top-28 right-24 focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 105,
    ...
    className: "relative flex flex-col w-full border-0 rounded-lg shadow-lg bg-yellow border-bordercolor focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108,
    ...
    className: "flex items-start justify-between p-8 rounded-t border-gray300",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 110,
...
//# sourceMappingURL=0.06bf7d03b34040972912.hot-update.js.map