...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all  self-end",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.0d133fccfcb390f3ea99.hot-update.js.map