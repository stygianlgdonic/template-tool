...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    className: "fixed z-50 flex items-center justify-center m-auto overflow-x-hidden overflow-y-hidden outline-none focus:outline-none",
    ref: myRef,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "relative flex flex-col w-full bg-white rounded-lg shadow-lg border-1 border-bordercolor focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 125,
...
//# sourceMappingURL=0.8d8c8dc1114291cad9bf.hot-update.js.map