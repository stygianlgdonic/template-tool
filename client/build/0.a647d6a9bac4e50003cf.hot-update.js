...
const Buttons = () => {
  return __jsx("div", {
    ...
    className: "flex flex-row justify-between  gap-4 h-28 overflow-x-scroll flex-grow",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
    ...
    className: "bg-yellowish text-white flex flex-row w-40 justify-center h-12 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    className: "bg-bluish text-white flex flex-row w-12 justify-center h-10 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=0.a647d6a9bac4e50003cf.hot-update.js.map