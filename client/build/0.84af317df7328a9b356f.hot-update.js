...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    className: "flex justify-around w-full mr-96",
    __self: undefined,
    __source: {
    ...
    type: "button",
    className: "relative w-full py-2 pl-3 pr-10 text-left rounded-lg shadow-sm cursor-default bg-radicalRed border- focus:outline-none focus:ring-border focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
...
//# sourceMappingURL=0.84af317df7328a9b356f.hot-update.js.map