...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " absolute inline-block align-bottom w-40 bg-white rounded-lg px-4 justify-center pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 333,
...
//# sourceMappingURL=0.242c6752e992fc6446aa.hot-update.js.map