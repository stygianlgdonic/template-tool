...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative w-32 mt-1 bg-fuschia h-9",
    ...
    className: "relative w-full py-2 pl-3 pr-10 text-left border border-gray-300 rounded-md shadow-sm cursor-default bg-red focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm",
    ...
    className: "absolute z-10 w-full py-1 mt-1 overflow-auto text-base bg-black rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
...
//# sourceMappingURL=0.d8e9edfa7dcc3abf3c05.hot-update.js.map