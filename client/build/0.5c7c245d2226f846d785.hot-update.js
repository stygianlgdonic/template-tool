...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-56 z-40 overflow-x-scroll no-scrollbar flex-shrink-0  bg-yellow  relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " h-28 z-50 bg-red w-12 -mr-12 bg-opacity-100 to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
...
//# sourceMappingURL=0.5c7c245d2226f846d785.hot-update.js.map