...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "absolute px-3 py-2 pl-3 pr-10 text-left border rounded-md shadow-sm cursor-default bg-yellowish border-gray300 w-36 h-7 focus:outline-none focus:ring-1 focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
    "aria-haspopup": "listbox",
    "aria-expanded": "true",
    "aria-labelledby": "listbox-label",
    __self: undefined,
...
//# sourceMappingURL=0.74d14b6de84cf275c5ba.hot-update.js.map