...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "flex items-center w-24 h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "pr-2 right-0 h-full flex items-center mt-32 fixed bg-transparent z-50 bg-red  ",
    onClick: () => {
      setIsOpen(false);
    },
    __self: this,
...
//# sourceMappingURL=0.32ef0c1ec6b914ccc7a7.hot-update.js.map