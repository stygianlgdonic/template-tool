...
const Stickers = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch('https://reserve.freesvg.org/api/v1/svgs').then(res => console.log(res)).catch(err => console.log(err));
  }, []);
...
//# sourceMappingURL=0.62a0aed903e6dc46ab44.hot-update.js.map