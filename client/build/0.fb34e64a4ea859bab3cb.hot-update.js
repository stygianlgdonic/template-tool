...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative w-auto max-w-3xl mx-auto my-6 bg-red",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 106,
    ...
    className: "relative flex flex-col w-full ml-5 border-0 rounded-lg shadow-lg bg-yellow border-bordercolor focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108,
...
//# sourceMappingURL=0.fb34e64a4ea859bab3cb.hot-update.js.map