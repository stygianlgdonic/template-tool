...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    id: "location",
    name: "location",
    className: "block w-full py-2 pl-3 pr-10 mt-1 text-base rounded-md border-gray300 focus:outline-none focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
    defaultValue: "",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.ed47039ce5dd453f321c.hot-update.js.map