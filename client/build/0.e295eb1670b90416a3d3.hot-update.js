...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "flex flex-row bg-indigo600 w-full rounded-md h-12 items-center justify-center mt-4",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
  ...
  }, "Select from gallery"))))))))), __jsx("section", {
...
//# sourceMappingURL=0.e295eb1670b90416a3d3.hot-update.js.map