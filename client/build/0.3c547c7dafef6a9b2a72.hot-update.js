...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " w-screen max-w-lg right-0 absolute bg-radicalpinkish h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " + (isOpen ? " translate-x-16 " : " translate-x-full "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=0.3c547c7dafef6a9b2a72.hot-update.js.map