...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row mt-4    overflow-x-scroll  items-center overflow-hidden  no-scrollbar bg-indigo",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    className: " h-28 z-50 -mr-12 bg-gradient-to-r w-12 from-white  bg-opacity-10 to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
    ...
    className: "flex flex-row   gap-4 h-28 w-72 z-0 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1    relative bg-yellow",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " h-28 z-50 mr-10 bg-gradient-to-r w-12 from-transparent bg-red bg-opacity-10 to-white",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
...
//# sourceMappingURL=0.b7ac957e302b13605d89.hot-update.js.map