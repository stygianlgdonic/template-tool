...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row mt-4  bg-redish  overflow-x-scroll  items-center overflow-hidden  no-scrollbar",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-80 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1    relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.9fdddf51931fae0eb05b.hot-update.js.map