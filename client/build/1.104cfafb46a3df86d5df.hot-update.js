...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-start text-left items-start leading-11  px-2 text-lightGray w-full  h-full mt-6 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9,
...
//# sourceMappingURL=1.104cfafb46a3df86d5df.hot-update.js.map