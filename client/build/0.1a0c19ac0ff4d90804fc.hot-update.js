...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative flex flex-row  items-center  py-2 px-4 text-left border-2 rounded-lg shadow-sm cursor-default h-10 border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.1a0c19ac0ff4d90804fc.hot-update.js.map