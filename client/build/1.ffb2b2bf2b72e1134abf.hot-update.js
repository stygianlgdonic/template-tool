...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-56 hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.ffb2b2bf2b72e1134abf.hot-update.js.map