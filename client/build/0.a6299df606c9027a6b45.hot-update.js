...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row  items-center gap-4 mt-1 ml-8",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102,
    ...
    className: "relative flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all  self-end",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.a6299df606c9027a6b45.hot-update.js.map