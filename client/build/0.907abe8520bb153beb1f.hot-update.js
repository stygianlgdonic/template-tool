...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../../../../../SubNavBar/components/ElementSelector/components/Stickers/style.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const TransformModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: "absolute z-10 w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg no-scrollbar max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
    "aria-activedescendant": "listbox-option-3",
    style: {
    ...
    className: "relative py-2 pl-3 text-gray-900 cursor-default select-none w-96 pr-9",
    id: "listbox-option-0",
    role: "option",
    __self: undefined,
    __source: {
  ...
  }, "Image_custom.pngdawdawdadadawdawdawdad"))))), __jsx("div", {
    className: "mt-6 ml-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.907abe8520bb153beb1f.hot-update.js.map