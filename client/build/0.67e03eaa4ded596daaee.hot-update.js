...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative flex flex-col items-center group mt-6 justify-end w-9/12  mx-auto mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 77,
    ...
    className: "absolute bottom-0 md:block flex-col items-center hidden mb-6 group-hover:flex",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 81,
    ...
    className: "w-3 h-6 -mt-2 rotate-45 bg-black",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 83,
...
//# sourceMappingURL=0.67e03eaa4ded596daaee.hot-update.js.map