...
const UText = ({
  ...
  var _textNode$current, _textNode$current$att, _textNode$current2, _textNode$current2$ge, _textNode$current3, _textNode$current3$ge;
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Text"], _extends({
    ...
    onTransform: e => {
      var _e$target$attrs, _e$target$attrs2;

      console.log({
        asasas: (_e$target$attrs = e.target.attrs) === null || _e$target$attrs === void 0 ? void 0 : _e$target$attrs.rotation
      });
      let SX = textNode.current.scaleX();
      let W = textNode.current.width();
      textAreaRef.current.style.transform = `rotateZ(${(_e$target$attrs2 = e.target.attrs) === null || _e$target$attrs2 === void 0 ? void 0 : _e$target$attrs2.rotation}deg)`;
      textAreaRef.current.style.transformOrigin = "center top";
...
//# sourceMappingURL=0.e145b138b28d5e8d00a0.hot-update.js.map