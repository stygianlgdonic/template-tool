...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-48 hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.caf9fb0411a4682d08b1.hot-update.js.map