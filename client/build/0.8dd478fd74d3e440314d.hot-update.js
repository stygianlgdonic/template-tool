...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-full text-left border-2 rounded-lg shadow-sm h-9  border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.8dd478fd74d3e440314d.hot-update.js.map