...
const UText = ({
  ...
  const {
    handleTextEdit
  } = Object(_Hooks_CardElementsFunctions__WEBPACK_IMPORTED_MODULE_2__["default"])(); // const [newTextObj, setNewTextObj] = useImmerState({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Text"], _extends({
    ...
    draggable: true,
    onClick: onSelect,
    onTap: onSelect // onDblClick={handleTextDblClick}
...
//# sourceMappingURL=0.950e7eda9ac74af138ab.hot-update.js.map