...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch(`https://api.color.pizza/v1/?names=${colorQuery}&goodnamesonly=true`).then(response => response.json()).then(data => console.log({
      data
    }));
  }, [colorQuery]);
  return __jsx("div", {
...
//# sourceMappingURL=0.7cc25cf6566cc8e0f85b.hot-update.js.map