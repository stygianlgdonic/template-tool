...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative flex items-end justify-center bg-red min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 242,
    ...
    className: " absolute inline-block align-bottom w-40  items-center bg-white rounded-lg px-4 justify-center overflow-hidden shadow-xl transform transition-all top-28 mt-2 self-end right-0 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 249,
...
//# sourceMappingURL=0.5f6b0cf94c44c730f3fb.hot-update.js.map