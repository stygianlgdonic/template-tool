...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "bg-blue-800 absolute",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 238,
    ...
    className: "  inline-block align-bottom w-40  items-center bg-white rounded-lg px-4 justify-center overflow-hidden shadow-xl transform transition-all top-28 right-10 mt-2 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 250,
...
//# sourceMappingURL=0.f76f513fa85426d087ab.hot-update.js.map