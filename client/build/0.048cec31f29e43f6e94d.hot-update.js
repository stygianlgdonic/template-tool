...
const ImageFallbackModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    // ref={myRef}
    className: "relative inset-0 z-10 flex items-center justify-center overflow-x-hidden bg-gray-900 outline-none focus:outline-none",
    __self: undefined,
    __source: {
  ...
  })), "Add Image"))))), console.log("lol", Open), __jsx("div", {
    style: {
      display: Open ? "" : "none"
    },
    __self: undefined,
...
//# sourceMappingURL=0.048cec31f29e43f6e94d.hot-update.js.map