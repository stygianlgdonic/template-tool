...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex items-center  hover:bg-rightbackgroundcolor w-full hover:rounded-lg border-0 rounded-sm pl-5 h-10 mb-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
    ...
    className: "mt-6 flex justify-end w-8/12 ml-12 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58,
...
//# sourceMappingURL=1.8011fd7bafbdd3ea27cc.hot-update.js.map