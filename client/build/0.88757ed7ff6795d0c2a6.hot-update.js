...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "inline-block align-bottom bg-white rounded-lg px-4 justify-center gap-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 333,
...
//# sourceMappingURL=0.88757ed7ff6795d0c2a6.hot-update.js.map