...
const TransformerComponent = ({
  ...
  var _$tr$current, _$tr$current$findOne, _$tr$current2, _$tr$current2$findOne;
  ...
  console.log((_$tr$current = $tr.current) === null || _$tr$current === void 0 ? void 0 : (_$tr$current$findOne = _$tr$current.findOne('.top-left')) === null || _$tr$current$findOne === void 0 ? void 0 : _$tr$current$findOne.position());
  console.log((_$tr$current2 = $tr.current) === null || _$tr$current2 === void 0 ? void 0 : (_$tr$current2$findOne = _$tr$current2.findOne('.top-right')) === null || _$tr$current2$findOne === void 0 ? void 0 : _$tr$current2$findOne.position());
  ...
  , {
    ...
    className: !!(selectedshape !== null && selectedshape !== void 0 && selectedshape.isFrame) ? "bg-red" : "hidden",
    style: {
      position: "absolute" // left: $tr.findOne('.top-right')?.position().x
...
//# sourceMappingURL=0.11f4944d13906ba37b1f.hot-update.js.map