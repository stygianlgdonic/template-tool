...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "456b13d38597e248b459";
...
module.exports = JSON.parse("{\"0\":{\"js\":[\"http://localhost:3001/static/js/0.chunk.js\"],\"map\":[\"http://localhost:3001/static/js/0.chunk.js.map\"],\"chunks\":[0]},\"1\":{\"js\":[\"http://localhost:3001/static/js/1.chunk.js\"],\"map\":[\"http://localhost:3001/static/js/1.chunk.js.map\"],\"chunks\":[1]},\"client\":{\"js\":[\"http://localhost:3001/static/js/client.js\"],\"map\":[\"http://localhost:3001/static/js/client.js.map\"],\"chunks\":[\"client\"]},\"noentry\":{\"png\":[\"http://localhost:3001/static/media/01.2e91d53b.png\",\"http://localhost:3001/static/media/02.adc8b2dd.png\",\"http://localhost:3001/static/media/03.6bbdf893.png\",\"http://localhost:3001/static/media/04.50f8bcb9.png\",\"http://localhost:3001/static/media/ALP-Summer.63b90db3.png\",\"http://localhost:3001/static/media/card1.9acd410d.png\",\"http://localhost:3001/static/media/card2.a3e6d397.png\",\"http://localhost:3001/static/media/card5.8baed643.png\",\"http://localhost:3001/static/media/glitch.c3fda1d1.png\",\"http://localhost:3001/static/media/image.f528bd77.png\",\"http://localhost:3001/static/media/image1.3ff551f0.png\",\"http://localhost:3001/static/media/image3.6df75f11.png\",\"http://localhost:3001/static/media/image4.9cb172b4.png\",\"http://localhost:3001/static/media/image5.f1b1f809.png\",\"http://localhost:3001/static/media/insta.638d5ee2.png\",\"http://localhost:3001/static/media/lift.b13cf734.png\",\"http://localhost:3001/static/media/neon.7fca1e10.png\",\"http://localhost:3001/static/media/preview.06b7f3b0.png\",\"http://localhost:3001/static/media/shadow.161b9d54.png\",\"http://localhost:3001/static/media/splice.6bc44619.png\"],\"jpg\":[\"http://localhost:3001/static/media/1.f5f798cc.jpg\"]}}");
...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (!!userObj.email && !!userObj.password) {
      ...
      if (!res.error) {
        sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Success", "You have logged in Successfully", {
  ...
  const onhandleSubmit = async e => {
    ...
    if (userObj.password !== userObj.againPassword) {
      ...
      if (!!res.error) {
        ...
        sweetalert__WEBPACK_IMPORTED_MODULE_2___default()(res.title, res.message, {
          closeOnClickOutside: false
...
/*!*******************************!*\
  !*** ./src/utils/defaults.ts ***!
  \*******************************/
/*! exports provided: hex_regex, googleFontsList, fontSizeArray, stageDimensions, ORIGINAL_SVG, defaultImage, defaultSvg, defaultRect, defaultRoundedRect, defaultCircle, defaultPolygon, defaultTriangle, defaultTextBox, defaultTextNoEffect, defaultTextHollow, defaultTextLift, defaultTextShadow, defaultTextSplice, defaultTextGlitch, defaultTextNeon, ORIGINAL_SVG_mailicon, ORIGINAL_SVG_imageicon, ORIGINAL_SVG_eyeicon, ORIGINAL_SVG_impressionicon, ORIGINAL_SVG_arrow_upicon, ORIGINAL_SVG_editicon, ORIGINAL_SVG_attachementicon, ORIGINAL_SVG_deleteicon, ORIGINAL_SVG_updownicon, ORIGINAL_SVG_bluedoticon, ORIGINAL_SVG_greendoticon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const hex_regex = /#[0-9a-fA-F]{6}|#[0-9a-fA-F]{3}/gi;
