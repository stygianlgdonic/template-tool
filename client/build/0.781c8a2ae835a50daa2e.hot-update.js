...
const CreateCardLayout = () => {
  ...
  return __jsx("div", {
    ...
    className: "w-10 absolute h-full right-0 top-0 z-0 bg-white pt-10",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
    ...
    className: "flex  bg-gray50 items-center h-full pt-10 z-0 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
    ...
    className: "w-6 h-10 bg-white rounded-r rounded-full flex items-center pl-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
...
//# sourceMappingURL=0.781c8a2ae835a50daa2e.hot-update.js.map