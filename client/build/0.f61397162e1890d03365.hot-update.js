...
const SubNavBar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex-row flex justify-between items-center mt-6 px-6 border",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
    ...
    className: "text-md text-gray40 mt-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
...
//# sourceMappingURL=0.f61397162e1890d03365.hot-update.js.map