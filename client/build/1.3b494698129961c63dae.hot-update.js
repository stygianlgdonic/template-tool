...
const ImagePreview = ({
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row border-2 px-4 py-1 rounded-md items-center text-gray94 text-sm border-bordercolor shadow-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
    ...
    className: "flex flex-row border-2 px-4 py-1 rounded-md items-center text-sm text-gray94 border-bordercolor shadow-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46,
...
//# sourceMappingURL=1.3b494698129961c63dae.hot-update.js.map