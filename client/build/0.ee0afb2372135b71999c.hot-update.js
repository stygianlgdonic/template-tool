...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 py-2 pl-3 pr-10 ml-2 text-left bg-white border rounded-md shadow-sm cursor-default border-gray300 h-7 focus:outline-none focus:ring-1 focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
    ...
    className: "relative mt-1 bg-red600",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 199,
    ...
    type: "button",
    className: "relative px-3 py-2 pl-3 pr-10 text-left border rounded-md shadow-sm cursor-default bg-yellowish border-gray300 w-36 h-7 focus:outline-none focus:ring-1 focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
    "aria-haspopup": "listbox",
    "aria-expanded": "true",
    "aria-labelledby": "listbox-label",
    __self: undefined,
    ...
    className: "relative z-10 p-3 text-xs leading-none text-white whitespace-no-wrap rounded-md shadow-lg ml-60 w-52 bg-indigo500",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 285,
...
//# sourceMappingURL=0.ee0afb2372135b71999c.hot-update.js.map