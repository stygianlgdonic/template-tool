...
const TextSelector = () => {
  return __jsx("div", {
    ...
    className: "hover:bg-indigo100 px-2 py-1 border-2 border-bordercolor w-2/6 h-9 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
    ...
    className: "hover:bg-indigo100 px-2 py-1 border-2 border-bordercolor h-9 rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
...
//# sourceMappingURL=0.9e4777f06010d1248a8b.hot-update.js.map