...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 px-2 py-1 pl-5 pr-5 text-left border rounded-md shadow-sm cursor-default bg-red border-gray300 h-7 focus:outline-none focus:ring-1 focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.43dc0c85c2b0862f6309.hot-update.js.map