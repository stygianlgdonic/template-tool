...
const RightSidebar = () => {
  ...
  return __jsx("div", {
    className: " overflow-y-hidden flex items-center  h-screen  px-4 bg-green",
    __self: undefined,
    __source: {
    ...
    className: "flex flex-col bg-yellow justify-center mx-auto no-scrollbar top-56",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54,
...
//# sourceMappingURL=1.12858b4b58abbd0326bc.hot-update.js.map