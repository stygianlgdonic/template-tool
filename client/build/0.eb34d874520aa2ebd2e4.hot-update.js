...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex items-center bg-white hover:bg-rightbackgroundcolor active:bg-bordercolor w-full hover:rounded-lg border-0 rounded-sm  pl-5 mb-1 h-10 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12,
...
//# sourceMappingURL=0.eb34d874520aa2ebd2e4.hot-update.js.map