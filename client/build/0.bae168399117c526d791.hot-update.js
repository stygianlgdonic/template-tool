...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "pl-4 h-full flex items-center mt-32 fixed bg-transparent z-50 bg-transparent ",
    onClick: () => {
      setIsOpen(false);
    },
    __self: this,
    ...
    className: "flex flex-col justify-start mt-6 w-full ml-6 bg-white h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
...
//# sourceMappingURL=0.bae168399117c526d791.hot-update.js.map