...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute z-10 py-0 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg w-52 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
...
//# sourceMappingURL=0.ab84d1c13c0047b2acd0.hot-update.js.map