...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "relative w-screen max-w-lg pb-10 flex flex-col  overflow-y-scroll h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "justify-center flex h-60 w-56",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 36,
    ...
    src: image,
    className: "border-bordercolor   shadow-lg flex justify-center",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
...
//# sourceMappingURL=0.78638c70bd24e8e2f92b.hot-update.js.map