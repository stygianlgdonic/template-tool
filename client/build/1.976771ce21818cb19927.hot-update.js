...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: dashboardnavigator === "home" ? "flex hover:bg-indigo100  mr-2 focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo mr-2  w-full hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
...
//# sourceMappingURL=1.976771ce21818cb19927.hot-update.js.map