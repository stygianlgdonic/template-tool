...
const ElementHeader = () => {
  ...
  const [opacityValues, setOpacityValues] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState([1]); // !!state?false:true;
  ...
  return __jsx("div", {
    ...
    renderThumb: ({
      ...
      className: "w-6 h-4 transform translate-x-10 bg-indigo600 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 150,
    ...
    value: Math.trunc(values * 100),
    onChange: e => {
      setValues([e.target.value]);
      handleTextOpacity(e.target.value);
    },
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.910bda987f7f1a68bc8e.hot-update.js.map