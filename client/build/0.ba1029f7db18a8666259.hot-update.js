...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute z-10 py-1 mt-1 overflow-auto w-32 text-base bg-white rounded-md shadow-lg max-h-60 ring-1 w-full ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
...
//# sourceMappingURL=0.ba1029f7db18a8666259.hot-update.js.map