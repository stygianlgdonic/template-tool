...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "inline-block align-bottom bg-white rounded-lg px-4 justify-center pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 333,
...
//# sourceMappingURL=0.c9cee7b37f15bc47f3d3.hot-update.js.map