...
const Buttons = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row items-center justify-between w-full px-4 mb-4 bg-red",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
    ...
    className: "z-0 flex flex-row items-center justify-between px-2 h-28 bg-yellow",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
...
//# sourceMappingURL=0.a8a911cc2f96b44b0917.hot-update.js.map