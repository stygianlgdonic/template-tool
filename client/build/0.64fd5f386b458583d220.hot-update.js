...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " absolute inline-block align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all top-28 mt-2 self-end right-56 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 428,
    ...
    className: "w-full flex gap-4 justify-center mb-4",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 430,
...
//# sourceMappingURL=0.64fd5f386b458583d220.hot-update.js.map