...
const App = () => {
  const routing = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["useRoutes"])([{
    path: '/',
    element: __jsx(_NoSSR__WEBPACK_IMPORTED_MODULE_2__["default"], {
      __self: undefined,
      __source: {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, routing);
};
...
//# sourceMappingURL=server.0bacba2a29d626aeb1e5.hot-update.js.map