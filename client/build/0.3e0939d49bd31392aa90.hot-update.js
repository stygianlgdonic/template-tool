...
const ElementHeader = ({
  ...
  console.log({
    treesaa: selectedelement === null || selectedelement === void 0 ? void 0 : selectedelement.patternImageUrl
  }); // const {
  //     $tr,
  ...
  // const getSelectedElementimgurl = () => {
  //     if (selectedId) {
  //         const selectedShape = cardData.elements.find(item => item.patternImageUrl === null)
  //         console.log("zinda")
  ...
  //     }
  // }
  // const selectedelementimgurl = getSelectedElementimgurl()
...
//# sourceMappingURL=0.3e0939d49bd31392aa90.hot-update.js.map