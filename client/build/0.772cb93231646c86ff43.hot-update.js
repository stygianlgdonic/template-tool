...
const TextHeader = ({
  ...
  const handleClickBold = () => {
    console.log({
      Weight: selectedText.fontWeight
    });
    handleFontWeight(selectedText.fontWeight === "bold" ? "normal" : "bold");
  };

  const handleClickItalic = () => {
    console.log({
      Style: selectedText.fontStyle
    });
...
//# sourceMappingURL=0.772cb93231646c86ff43.hot-update.js.map