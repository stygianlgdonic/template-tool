...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-72 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1  bg-gradient-to-r from-grey to-darkgray  relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.bcf5f73a575990cd01b2.hot-update.js.map