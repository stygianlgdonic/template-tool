...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " w-screen max-w-lg right-0 absolute bg-white h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform items-center " + (isOpen ? " translate-x-0  " : " translate-x-full "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
    ...
    className: "relative w-screen max-w-full pb-10 flex flex-col h-full overflow-y-scroll h-full border-4 border-black ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "h-full flex border-4 border-red600 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
    ...
    className: "pl-4  h-full flex items-center bg-yellow",
    onClick: () => {
      setIsOpen(false);
    },
    __self: this,
    ...
    className: "flex flex-col justify-start mt-6 w-full bg-green",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
...
//# sourceMappingURL=0.13e4da211c75280dc4a9.hot-update.js.map