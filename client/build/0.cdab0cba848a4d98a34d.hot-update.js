...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative flex flex-row  items-center  py-2 px-4 text-left border-2 rounded-lg shadow-sm  h-10 border-bordercolor hover:lightindigo focus:outline-none focus:ring-border  sm:text-sm",
...
//# sourceMappingURL=0.cdab0cba848a4d98a34d.hot-update.js.map