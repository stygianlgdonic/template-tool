...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch(`https://api.color.pizza/v1/names/?name=${colorQuery}&values=${colorQuery}&goodnamesonly=true`).then(response => response.json()).then(data => {
...
//# sourceMappingURL=0.d6eed9947e8cfa27d4c1.hot-update.js.map