...
const TransformerComponent = ({
  ...
  const handleOpenFallbackModal = () => {
    ...
    if (!!nodes.length && ((_nodes$ = nodes[0]) === null || _nodes$ === void 0 ? void 0 : (_nodes$$attrs = _nodes$.attrs) === null || _nodes$$attrs === void 0 ? void 0 : _nodes$$attrs.id.split("_")) === "shapes") {
...
//# sourceMappingURL=4.3fcfdb616efe1dc93cb0.hot-update.js.map