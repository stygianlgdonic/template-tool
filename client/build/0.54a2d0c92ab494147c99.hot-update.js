...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute z-10 py-1 mt-1 overflow-auto text-base rounded-md shadow-lg bg-red w-52 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
    ...
    className: "relative w-full py-2 pl-8 pr-4 text-gray-900 cursor-default select-none bg-fuschia",
    id: "listbox-option-0",
    role: "option",
    __self: undefined,
    __source: {
...
//# sourceMappingURL=0.54a2d0c92ab494147c99.hot-update.js.map