...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: " w-10 flex-grow z-20 fixed opacity-50 h-28 bg-gradient-to-r from-red to-transparent -ml-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-80 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1 z-50 relative ml-1 bg-yellow border-l-4 border-red border-opacity-30",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "border-r-4 border-red",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
...
//# sourceMappingURL=0.997d6570351558031198.hot-update.js.map