...
const Shapes = ({
  ...
  const handleAddElement = elementName => {
    elementName === "" && handleAddNewRect(_utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultRect"]);
    elementName === "" && handleAddNewCircle(_utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultCircle"]);
    elementName === "" && handleAddNewTrianlge(_utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultTriangle"]);
    elementName === "" && handleAddNewPolygon(_utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultPolygon"]);
  };
...
//# sourceMappingURL=0.e67b91d4eb4e0a97474c.hot-update.js.map