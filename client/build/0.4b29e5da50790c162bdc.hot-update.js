...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " w-screen max-w-lg right-0 absolute bg-white h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " + (isOpen ? " translate-x-2 " : " translate-x-full "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=0.4b29e5da50790c162bdc.hot-update.js.map