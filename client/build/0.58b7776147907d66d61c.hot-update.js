...
const TextHeader = ({
  ...
  const handleClickBold = () => {
    console.log({
      Weight: selectedText.fontWieght
    });
    handleFontWeight(selectedText.fontWieght === "bold" ? "normal" : "bold");
  };
  ...
  const handleClickItalic = () => {
    ...
    handleFontStyle(selectedText.fontStyle === "bold" ? "normal" : "italic");
  };
...
//# sourceMappingURL=0.58b7776147907d66d61c.hot-update.js.map