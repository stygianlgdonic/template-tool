...
const MainStage = ({
  ...
  const _onDragMove = e => {
    ...
    const isWrapped = (_$tr$current2 = $tr.current) === null || _$tr$current2 === void 0 ? void 0 : (_$tr$current2$nodes = _$tr$current2.nodes()) === null || _$tr$current2$nodes === void 0 ? void 0 : _$tr$current2$nodes.some(node => node.attrs.id === guideItem.attrs.id);
    if (isWrapped) return;
    drawGuides(guides);
    guides.forEach(lg => {
      switch (lg.snap) {
...
//# sourceMappingURL=0.1122a5a07611859d0c73.hot-update.js.map