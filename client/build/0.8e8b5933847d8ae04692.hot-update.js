...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all  self-end right-14 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.8e8b5933847d8ae04692.hot-update.js.map