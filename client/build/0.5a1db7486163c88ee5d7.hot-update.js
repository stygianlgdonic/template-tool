...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 py-2 pl-3 pr-10 text-left border-2 rounded-lg shadow-sm  h-9 border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.5a1db7486163c88ee5d7.hot-update.js.map