...
const TransformerComponent = ({
  ...
  var _editIconRef$current, _$tr$current, _$tr$current$findOne;
  ...
  console.log({
    width: (_editIconRef$current = editIconRef.current) === null || _editIconRef$current === void 0 ? void 0 : _editIconRef$current.getBoundingClientRect()
  });
  ...
  , {
    ...
    style: {
      position: "absolute",
      left: ((_$tr$current = $tr.current) === null || _$tr$current === void 0 ? void 0 : (_$tr$current$findOne = _$tr$current.findOne('.top-right')) === null || _$tr$current$findOne === void 0 ? void 0 : _$tr$current$findOne.position().x) - 10
    },
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.6332d86a48d9bcf2f7c8.hot-update.js.map