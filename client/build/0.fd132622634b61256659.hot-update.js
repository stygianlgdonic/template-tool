...
const TextSelector = () => {
  return __jsx("div", {
    ...
    className: "hover:font-bold px-2 py-1 border-2 border-bordercolor w-32 h-9 rounded-md ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
    ...
    className: "text-sm  hover:bg-indigo100 font-normal",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
...
//# sourceMappingURL=0.fd132622634b61256659.hot-update.js.map