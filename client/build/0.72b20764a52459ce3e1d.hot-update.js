...
const AddBackgroundImage = () => {
  return __jsx("div", {
    ...
    className: "fixed inset-0 transition-opacity bg-opacity-75 bg-grey500",
    "aria-hidden": "true",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "mt-3 text-right sm:mt-5",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 125,
    ...
    role: "list",
    className: "gr`id grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 129,
    ...
    className: "gr`oup block w-full aspect-w-10 aspect-h-7 rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-indigo-500 overflow-hidden",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 134,
    ...
    alt: "",
    className: "ob`ject-cover pointer-events-none group-hover:opacity-75",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 135,
    ...
    type: "button",
    className: "ab`solute inset-0 focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 140,
  ...
  }, "View details for IMG_4985.HEIC")))), __jsx("p", {
  ...
  }, "IMG_4985.HEIC"), __jsx("p", {
    className: "bl`ock text-sm font-medium text-gray-500 pointer-events-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 153,
    ...
    type: "button",
    className: "inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-indigo600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 164,
...
//# sourceMappingURL=0.72b20764a52459ce3e1d.hot-update.js.map