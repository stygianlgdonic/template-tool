...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-full text-left border-2 rounded-lg shadow-sm h-9  px-4 border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.aad3687c2050ee065c3c.hot-update.js.map