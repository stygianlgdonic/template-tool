...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch(`https://api.color.pizza/v1/names/${colorQuery}`).then(response => response.json()).then(data => console.log(data));
  }, [colorQuery]);
  return __jsx("div", {
...
//# sourceMappingURL=0.c820e80f5718951eb3db.hot-update.js.map