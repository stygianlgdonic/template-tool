...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative flex flex-col w-full bg-white border-0 rounded-lg shadow-md shadow-lg outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58,
...
//# sourceMappingURL=0.23470a731c6046ae4888.hot-update.js.map