...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative w-32 mt-1 border h-9 border-bordercolor",
    ...
    className: "relative w-full py-2 pl-3 pr-10 text-left bg-white border border-gray-300 rounded-md shadow-sm cursor-default focus:outline-none focus:ring-border focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
...
//# sourceMappingURL=0.a195d1ae9388cca98a20.hot-update.js.map