...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "relative flex-auto p-6 font-bold text-createEmail font-inter ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87,
    ...
    className: "font-bold text-createEmail font-inter ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 103,
    ...
    className: "mt-6 mb-6 font-bold text-createEmail font-inter",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 137,
    ...
    className: "flex items-start justify-between w-full p-5 border-b border-solid rounded-t border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 200,
    ...
    className: "flex flex-row h-8 px-2 mr-2 border-2 rounded-md text-gray900 w border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 207,
    ...
    className: "block w-8 text-lg text-white bg-transparent outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 220,
...
//# sourceMappingURL=1.a9eb24874faf5df61cf2.hot-update.js.map