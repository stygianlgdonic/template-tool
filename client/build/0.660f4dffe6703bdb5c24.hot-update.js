...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white border border-transparent rounded-md shadow-sm bg-deletebutton hover:bg-deletebutton focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
...
//# sourceMappingURL=0.660f4dffe6703bdb5c24.hot-update.js.map