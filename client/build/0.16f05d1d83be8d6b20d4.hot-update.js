...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "block truncate border-4 border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
    ...
    className: "block w-full h-4 truncate border-4 border-bordercolor bg-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 59,
    ...
    className: "block w-full h-2 font-normal truncate border-2 border-bordercolor bg-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63,
    ...
    className: "block w-full h-1 font-normal truncate border-2 border-bordercolor bg-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 67,
    ...
    className: "divide-y-4 divide-black divide-opacity-25",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 71,
    ...
    className: "flex flex-row items-center grid-cols-3 grid-rows-6 gap-4 mt-4 ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
    ...
    className: "h-10 rounded-md w-28 bg-indigo600",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74,
    ...
    className: "h-10 rounded-md w-28 bg-fuschia",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 75,
    ...
    className: "h-10 rounded-md w-28 bg-greenish",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 76,
    ...
    className: "h-10 rounded-md w-28 bg-yellowish",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 77,
    ...
    className: "h-10 rounded-md w-28 bg-redish",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 78,
...
//# sourceMappingURL=0.16f05d1d83be8d6b20d4.hot-update.js.map