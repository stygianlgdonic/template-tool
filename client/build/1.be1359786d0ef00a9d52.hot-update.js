...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-52 hover:rounded-lg border-0 rounded-md pl-4",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.be1359786d0ef00a9d52.hot-update.js.map