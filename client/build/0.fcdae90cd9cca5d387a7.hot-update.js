...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " absolute inline-block align-bottom w-40  items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all  mt-2 self-end  ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.fcdae90cd9cca5d387a7.hot-update.js.map