...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex items-center mt-1 ml-auto mr-1 text-sm font-semibold leading-none text-black rounded-full outline-none focus:outline-none",
    ...
    className: "block w-8 text-lg  bg-transparent outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 220,
...
//# sourceMappingURL=1.72b4243c034deddec6f2.hot-update.js.map