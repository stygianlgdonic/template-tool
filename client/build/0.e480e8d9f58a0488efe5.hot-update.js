...
const TransformModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: "absolute z-10 py-1 mt-1 overflow-auto overflow-y-hidden text-base bg-white rounded-md shadow-lg w-36 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
    "aria-activedescendant": "listbox-option-3",
    style: {
...
//# sourceMappingURL=0.e480e8d9f58a0488efe5.hot-update.js.map