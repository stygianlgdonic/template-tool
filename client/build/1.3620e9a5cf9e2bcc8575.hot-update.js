...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    className: "h-full  flex flex-col bg-yellow w-full ",
    __self: undefined,
    __source: {
    ...
    className: dashboardnavigator === "home" ? "flex hover:bg-lightindigo  focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo  w-60 hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
...
//# sourceMappingURL=1.3620e9a5cf9e2bcc8575.hot-update.js.map