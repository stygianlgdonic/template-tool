...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row  items-center gap-4 mt-1 ml-8 bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102,
    ...
    className: "ml-6 mt-2 relative bg-yellow",
    ...
    className: "absolute flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl top-32 transform transition-all right-96  self-end",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
    ...
    className: "py-4   border-r-2 border-bordercolor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 156,
    ...
    className: " flex bg-deletecolor rounded-md w-10 h-9 items-center justify-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 158,
...
//# sourceMappingURL=0.8fb22eda20db87d7df8f.hot-update.js.map