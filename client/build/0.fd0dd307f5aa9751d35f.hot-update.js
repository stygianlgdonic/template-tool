...
const MainStage = ({
  ...
  const onClickTap = e => {
    console.log("clcktap"); // if we are selecting with rect, do nothing
    ...
    if (e.target.attrs.id === "shapes_background") {
      setSelectedId(null);
      setNodes([]);
      tr.nodes([]);
      layer.draw();
...
//# sourceMappingURL=0.fd0dd307f5aa9751d35f.hot-update.js.map