...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 py-2 pl-3 pr-10 text-left rounded-lg shadow-sm cursor-default h-9 border- focus:outline-none focus:ring-border focus:ring-indigo500 focus:border-indigo500 sm:text-sm",
...
//# sourceMappingURL=0.ad64595a7a6a0517f1e7.hot-update.js.map