...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch(`https://api.color.pizza/v1/?names=${colorQuery}&goodnamesonly=true`).then(response => response.json()).then(data => {
      const newColors = data.colors.map(item => colorQuery.hex);
      setColorsArray(data.splice(5));
    });
  }, [colorQuery]);
  console.log({
    colorsArray
...
//# sourceMappingURL=0.3c8da7900b20cb28bb4c.hot-update.js.map