...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative w-full py-2 pl-4 mr-8 text-gray-900  bg-red cursor-default select-none ",
    id: "listbox-option-0",
    role: "option",
    __self: undefined,
    __source: {
    ...
    className: "flex w-full  px-4 py-1 rounded-md hover:bg-lightindigo",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=0.05c30c50deab3cf45154.hot-update.js.map