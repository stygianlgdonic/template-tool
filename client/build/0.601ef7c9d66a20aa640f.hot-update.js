...
const CreateCardLayout = () => {
  ...
  return __jsx("div", {
    ...
    className: "w-24 absolute h-full right-0 top-0 bg-white ",
    style: {
      paddingTop: '54px'
    },
    __self: undefined,
    ...
    className: "w-10 h-20 ml-10 bg-white rounded-r rounded-full  flex items-center pl-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
...
//# sourceMappingURL=0.601ef7c9d66a20aa640f.hot-update.js.map