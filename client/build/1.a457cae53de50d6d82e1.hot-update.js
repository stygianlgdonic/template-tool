...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "relative  w-auto my-6 z-50 mx-auto max-w-4xl bg-white",
    style: {
      height: '85vh'
    },
    __self: undefined,
    ...
    className: "p-1 ml-auto  right-0 top-0 text-black  float-right text-3xl leading-none font-semibold outline-none focus:outline-none",
    ...
    className: "border-2 border-dashed rounded-md border-bordercolor justify-center items-center flex flex-col py-2 bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 107,
  ...
  }, "Create New Personalized Template"))), "S", __jsx("div", {
    ...
    className: "bg-indigo500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150",
    type: "button",
    onClick: () => setShowModal(false),
    __self: undefined,
    __source: {
...
//# sourceMappingURL=1.a457cae53de50d6d82e1.hot-update.js.map