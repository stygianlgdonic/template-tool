...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    className: "h-full  flex flex-col  w-full bg-yellow",
    __self: undefined,
    __source: {
    ...
    className: "ml-4 font-sans leading-tight mt-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
    ...
    className: "flex flex-col justify-center text-left items-start leading-10 text-lightGray   ",
    style: {
      width: '33.5vh'
    },
    __self: undefined,
    ...
    className: dashboardnavigator === "home" ? "flex hover:bg-indigo100   focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-indigo100   focus:bg-lightindigo mr-2  w-full hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
...
//# sourceMappingURL=1.d974865bb70752540ab2.hot-update.js.map