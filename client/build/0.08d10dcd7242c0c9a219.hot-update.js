...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    onChange: values => {
      setValues(values);
      handleTextOpacity(parseFloat(values) / 100);
    },
    renderTrack: ({
      props,
      children
    ...
    renderThumb: ({
      ...
      className: "w-5 h-4 transform translate-x-10 bg-indigo600 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 149,
...
//# sourceMappingURL=0.08d10dcd7242c0c9a219.hot-update.js.map