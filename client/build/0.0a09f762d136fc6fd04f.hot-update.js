...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative w-32 py-2 pl-3 pr-10 ml-2 text-left bg-white border rounded-md shadow-sm cursor-default border-gray300 h-7 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm",
...
//# sourceMappingURL=0.0a09f762d136fc6fd04f.hot-update.js.map