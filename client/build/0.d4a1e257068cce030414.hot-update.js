...
const CreateCardLayout = () => {
  ...
  return __jsx("div", {
    ...
    className: "w-8 absolute h-full right-0 top-0 z-0 bg-white flex items-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
    ...
    className: "w-6   absolute bg-gray50 h-full bg-opacity-100",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: "flex bg-red items-center   z-50",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
...
//# sourceMappingURL=0.d4a1e257068cce030414.hot-update.js.map