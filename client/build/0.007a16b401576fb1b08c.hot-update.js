...
const TextHeader = ({
  ...
  const handleChangeFontStyle = () => {
    /*
        !!fontStyle.bold && !!fontStyle.italic => "italic bold"
        !!fontStyle.bold && !fontStyle.italic => "bold"
        !fontStyle.bold && !!fontStyle.italic => "italic"
        !fontStyle.bold && !fontStyle.italic => "normal"
    */
    // handleFontStyle()
  };
  ...
  return __jsx("div", {
  ...
  }, !!selectedText ? (_fontSizeArray$find = _utils_defaults__WEBPACK_IMPORTED_MODULE_4__["fontSizeArray"].find(item => item.size === selectedText.fontSize)) === null || _fontSizeArray$find === void 0 ? void 0 : _fontSizeArray$find.name : "Heading"), __jsx("ul", {
  ...
  }, _utils_defaults__WEBPACK_IMPORTED_MODULE_4__["fontSizeArray"].map((item, index) => __jsx("div", {
    key: index,
    className: "flex mb-2 ",
    __self: undefined,
    __source: {
    ...
    className: "ml-4 text-lg font-bold text-black w-10 h-10 rounded-md" + ((_selectedText$fontSty = selectedText.fontStyle) !== null && _selectedText$fontSty !== void 0 && _selectedText$fontSty.includes("bold") ? " bg-lightindigo" : ""),
    ...
    className: "ml-4 text-lg italic font-bold text-black w-10 h-10 rounded-md" + ((_selectedText$fontSty2 = selectedText.fontStyle) !== null && _selectedText$fontSty2 !== void 0 && _selectedText$fontSty2.includes("italic") ? " bg-lightindigo" : ""),
    onClick: handleChangeFontStyle,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.007a16b401576fb1b08c.hot-update.js.map