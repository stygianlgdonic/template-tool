...
const TextSelector = () => {
  ...
  const handleTextAdd = type => {
    ...
    setCardData(prev => {
      prev.elements.push(_objectSpread(_objectSpread({}, _utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultTextBox"]), {}, {
        textTypeFont
      }));
    });
  };
  ...
  return __jsx("div", {
    ...
    className: " leading-none font-normal text-gray94 mb-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
...
//# sourceMappingURL=0.2c8a3c3b8215de40a1cf.hot-update.js.map