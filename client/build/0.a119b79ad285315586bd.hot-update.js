...
const FontStyletool = () => {
  ...
  return __jsx("div", {
    ...
    className: " mt-4 grid grid-cols-8 items-center flex-shrink-0 overflow-x-auto mb-2 justify-between",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80,
    ...
    className: "h-10 w-10 rounded-md border mb-2 border-gray-500",
    onClick: () => handleFill(item),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.a119b79ad285315586bd.hot-update.js.map