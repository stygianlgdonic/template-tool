...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: " fixed overflow-y-auto no-scrollbar z-50  flex-grow  bg-gray-900  inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0 translate-y-16  " : " transition-all delay-500  translate-x-full "),
    __self: this,
    __source: {
    ...
    className: "flex items-center bg-red h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "pl-4  h-full flex items-center mt-32 fixed ",
    onClick: () => {
      setIsOpen(false);
    },
    __self: this,
...
//# sourceMappingURL=0.bc3dfde056621680e3f8.hot-update.js.map