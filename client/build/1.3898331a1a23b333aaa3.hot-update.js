...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row justify-center bg-red ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68,
    ...
    className: "flex justify-center mt-2 bg-yellow",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
    ...
    className: "bg-green flex justify-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 79,
...
//# sourceMappingURL=1.3898331a1a23b333aaa3.hot-update.js.map