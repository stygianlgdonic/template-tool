...
const BackgroundColorModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    type: "button",
    className: " w-14 font-inter h-10 inline-flex items-center px-3 py-1.5 border-2 border-gray300 text-xs font-medium rounded-md shadow-sm   " + (fillType === "solid" ? "text-gradientColor bg-jacksonsGray" : "bg-SolidColor text-white"),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
    ...
    type: "button",
    className: "w-28 font-inter h-10 inline-flex text-center items-center px-5 py-1.5 border-2 border-gray300 text-xs font-medium  rounded-md shadow-sm " + (fillType === "gradient" ? "text-gradientColor bg-jacksonsGray" : "bg-SolidColor text-white"),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64,
...
//# sourceMappingURL=0.95ffa9f48731234c7fb3.hot-update.js.map