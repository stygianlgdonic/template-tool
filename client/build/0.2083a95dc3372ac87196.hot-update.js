...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    console.log(colorQuery.charAt(0) === "#");
    fetch(`https://api.color.pizza/v1/names/?name=${colorQuery}&goodnamesonly=true`).then(response => response.json()).then(data => {
...
//# sourceMappingURL=0.2083a95dc3372ac87196.hot-update.js.map