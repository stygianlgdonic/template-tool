...
const FontStyletool = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    fetch(`https://api.color.pizza/v1/names/?values=${colorQuery}&goodnamesonly=true`).then(response => response.json()).then(data => {
...
//# sourceMappingURL=0.4bdfeb96cb8894ea9b5e.hot-update.js.map