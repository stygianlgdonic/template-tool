...
const SelectSocialMediaTemplateModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: "grid grid-cols-2 bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
    ...
    style: {
      ...
      width: index === 0 ? "379px" : "297px",
      marginRight: index === 0 ? "20px" : "0px"
    },
    className: "h-40 border-2 border-transparent shadow-md gap-4 w-96 rounded-md ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
    ...
    style: {
      ...
      position: index === 2 ? "absolute" : "absolute",
      top: index === 2 ? 200 : 200,
...
//# sourceMappingURL=1.88d2261b37f777bccc8f.hot-update.js.map