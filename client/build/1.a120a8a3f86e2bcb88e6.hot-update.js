...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    className: "h-full fixed flex flex-col bg-gray-50 w-full",
    __self: undefined,
    __source: {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo   hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.a120a8a3f86e2bcb88e6.hot-update.js.map