...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (!!userObj.email && !!userObj.password) {
      ...
      if (!res.error) {
        sweetalert__WEBPACK_IMPORTED_MODULE_4___default()("Success", "You have logged in Successfully", {
          closeOnClickOutside: false
        }).then(() => navigate("/"));
      } else {
        sweetalert__WEBPACK_IMPORTED_MODULE_4___default()("Error", res.error.message);
      }
    } else {
      sweetalert__WEBPACK_IMPORTED_MODULE_4___default()("error", "Please provide complete details");
    }
  };
...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (userObj.password !== userObj.againPassword) {
      sweetalert__WEBPACK_IMPORTED_MODULE_4___default()("Error", "Passwords dont match, Try again!");
      ...
      if (!!res.error) {
        ...
        sweetalert__WEBPACK_IMPORTED_MODULE_4___default()(res.title, res.message, {
          closeOnClickOutside: false
...
//# sourceMappingURL=server.d8f468d7b9bb880f95e9.hot-update.js.map