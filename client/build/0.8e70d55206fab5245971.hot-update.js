...
const TransformModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, " ", __jsx("div", {
    className: "z-50 flex items-center justify-center w-screen h-screen overflow-x-auto overflow-y-auto outline-none bg-indigo600 inherit focus:outline-none",
    __self: undefined,
    __source: {
    ...
    ref: myRef,
    className: "absolute z-50 w-screen h-screen max-w-4xl mx-auto my-6 bg-white rounded-md ",
    style: {
      height: "90vh"
    },
    __self: undefined,
...
//# sourceMappingURL=0.8e70d55206fab5245971.hot-update.js.map