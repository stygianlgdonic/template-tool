...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "relative w-screen max-w-full pb-24 flex flex-col h-full overflow-y-scroll no-scrollbar  ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
    ...
    className: "bg-white rounded-r rounded-full h-20 items-center w-10 flex flex-row pl-2 ml-1",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
...
//# sourceMappingURL=0.3e1d1826a020c71204f6.hot-update.js.map