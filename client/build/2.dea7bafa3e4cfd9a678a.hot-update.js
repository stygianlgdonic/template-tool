...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (!!userObj.email && !!userObj.password) {
      ...
      sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Success", "You have logged in Successfully").then(navigate("/Dashboard"));
    } else {
...
//# sourceMappingURL=2.dea7bafa3e4cfd9a678a.hot-update.js.map