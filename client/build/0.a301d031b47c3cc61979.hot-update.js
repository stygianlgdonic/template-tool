...
const AddBackgroundImage = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none bg-radicalRed focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
    ...
    className: "relative w-auto max-w-3xl mx-auto my-6 bg-indigo700",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63,
...
//# sourceMappingURL=0.a301d031b47c3cc61979.hot-update.js.map