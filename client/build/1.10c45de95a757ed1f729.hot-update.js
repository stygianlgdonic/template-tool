...
const SelectSocialMediaTemplateModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: "flex items-start justify-between p-5 rounded-t bg-red ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
    ...
    className: "relative flex-auto p-7 mb-6 text-lg font-bold text-createEmail font-inter bg-yellow ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=1.10c45de95a757ed1f729.hot-update.js.map