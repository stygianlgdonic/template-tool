...
const SelectSocialMediaTemplateModal = ({
  ...
  const navigate = Object(react_router__WEBPACK_IMPORTED_MODULE_1__["useNavigate"])();
  const {
    cardData,
    setCardData
  ...
  const createNewCard = cardDimensions => {
    setCardData(prev => {
      ...
      prev.labels = [];
      prev.elements = [_objectSpread(_objectSpread({}, INITIAL_STATE.elements[0]), {}, {
...
//# sourceMappingURL=1.2a77fe0f74b3fd0f96fc.hot-update.js.map