...
const MainStage = ({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    if (!nodesArray.length) {// emptyCardHeader()
    }
  }, [nodesArray.length]);
  ...
  const onMouseUp = () => {
    ...
    $tr.current.nodes(elements); // setNodes(elements)
    ...
    if (elem.type === "rectangle") return __jsx(_Rectangle__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      onSelect: e => {
        ...
        if (e.current !== undefined) {
          ...
          setNodes(temp);
          $tr.current.nodes(nodesArray); // $tr.current.nodes(nodesArray);
...
//# sourceMappingURL=0.75afbae8158dafda238e.hot-update.js.map