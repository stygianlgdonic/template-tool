...
const BackgroundColorModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    type: "button",
    className: "w-14 font-inter h-10 inline-flex items-center px-3 py-1.5 border-2 border-gray300 text-xs font-medium rounded-md shadow-sm text-gradientColor bg-jacksonsGray  focus:bg-SolidColor focus:text-white",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
    ...
    type: "button",
    className: "w-28 font-inter h-10 inline-flex text-center items-center px-3 py-1.5 border-2 border-gray300 text-xs font-medium rounded-md shadow-sm text-gradientColor bg-jacksonsGray  focus:bg-SolidColor focus:text-white",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
    ...
    className: "h-32 mt-3 mb-5 ml-5 w-44 bg-gradient-to-r from-yellow via-red to-indigo700 left-5 top-32 p-7",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87,
...
//# sourceMappingURL=0.4b8cd21cebcd49ab68bd.hot-update.js.map