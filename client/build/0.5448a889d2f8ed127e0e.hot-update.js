...
function Drawer({
  ...
  return __jsx("main", {
    className: " fixed overflow-hidden z-10 bg-gray-900 bg-opacity-25 inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0  " : " transition-all delay-500 opacity-0 translate-x-full translate-y-14 "),
    __self: this,
    __source: {
...
//# sourceMappingURL=0.5448a889d2f8ed127e0e.hot-update.js.map