...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "fixed mt-16 pl-1 mr-1 ",
    onClick: () => {
    ...
    className: "flex flex-row mt-4 gap-4 h-28  overflow-x-scroll flex-shrink-0 overflow-hidden pl-6 no-scrollbar",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " fixed mt-16 z-50 pl-4 ",
    onClick: () => {
      sideScroll(contentWrapper.current, 25, 100, 10);
    },
    __self: undefined,
...
//# sourceMappingURL=0.01ca1de655cce1b8e303.hot-update.js.map