...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: " w-10 -mr-2 flex-grow z-20 fixed opacity-50 h-28 bg-gradient-to-r from-red to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48,
    ...
    className: "flex flex-row flex-grow  gap-4 h-28 w-80 overflow-x-scroll no-scrollbar flex-shrink-0  mx-1 z-50  relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.6152493357941e6149aa.hot-update.js.map