...
function Drawer({
  ...
  return __jsx("main", {
    ...
    className: "flex items-center w-28  h-full",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: " pl-4 mr-2 h-full flex items-center mt-32 fixed b z-50 bg-transparent  ",
    onClick: () => {
      setIsOpen(false);
    },
    __self: this,
    ...
    className: "bg-green rounded-r rounded-full h-14 items-center w-24 flex flex-row -mr-16 ",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32,
    ...
    className: "flex flex-col justify-start w-full ml-6 bg-white h-full px-6",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
...
//# sourceMappingURL=0.c01c4dc86616d524c7f9.hot-update.js.map