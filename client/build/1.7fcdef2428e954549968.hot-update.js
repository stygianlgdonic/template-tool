...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex items-start justify-between w-full pl-5 pb-3 pt-2 border-b border-solid rounded-t border-bordercolor bg-red",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 200,
    ...
    className: "flex items-center mt-1 ml-auto mr-1 text-sm font-semibold leading-none text-black opacity-30 rounded-full outline-none focus:outline-none",
    ...
    className: "block w-8 text-2xl   bg-transparent outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 220,
...
//# sourceMappingURL=1.7fcdef2428e954549968.hot-update.js.map