...
const SelectSocialMediaTemplateModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: " flex justify-between mt-2 ml-2 bg-red ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33,
    ...
    className: " text-base font-light float-right mr-3  ml-auto  leading-none text-black border-0 outline-none  focus:outline-none",
    onClick: closeModal,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=1.6d674b4917e904e5f6f0.hot-update.js.map