...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row mt-4  overflow-x-scroll   overflow-hidden  no-scrollbar",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "fixed mt-16 pl-1 pr-1 ",
    onClick: () => {
    ...
    className: " fixed mt-16 z-50 pl-4 right-auto left-auto",
    onClick: () => {
      sideScroll(contentWrapper.current, 25, 100, 10);
    },
    __self: undefined,
...
//# sourceMappingURL=0.d16dd25994cd1cd679e2.hot-update.js.map