...
const Frames = () => {
  return __jsx("div", {
    className: " flex   flex-col justify-center w-full bg-yellow ",
    __self: undefined,
    __source: {
    ...
    className: "mt-6 w-full grid grid-cols-3 gap-4 bg-radicalRed",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12,
...
//# sourceMappingURL=1.73d1dbf3272ff44d0451.hot-update.js.map