...
const ReceipentsLogo = () => {
  ...
  const handleClickOutside = e => {
    console.log({
      LOL: myRef === null || myRef === void 0 ? void 0 : myRef.current.contains(e.target)
    });

    if (!(myRef !== null && myRef !== void 0 && myRef.current.contains(e.target))) {
  ...
  return __jsx("div", {
    ...
    ref: myRef,
    className: "fixed z-50 flex items-center justify-center p-12 overflow-x-hidden overflow-y-auto outline-none top-28 right-24 focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 121,
...
//# sourceMappingURL=0.9191b8b4d2b3f06bf7ab.hot-update.js.map