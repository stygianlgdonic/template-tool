...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    renderTrack: ({
      ...
      className: "w-full h-3 pr-2 my-4 bg-indigo400 rounded-md",
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 300,
    ...
    renderThumb: ({
      ...
      className: "w-5 h-5 transform translate-x-10 bg-red rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 308,
...
//# sourceMappingURL=0.e4ce463cb8b17461f76c.hot-update.js.map