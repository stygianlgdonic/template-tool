...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col w-full mx-auto justify-center mt-4 h-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
    ...
    className: "justify-center items-center h-4/6 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51,
...
//# sourceMappingURL=1.ecbc0d8bca50162fce84.hot-update.js.map