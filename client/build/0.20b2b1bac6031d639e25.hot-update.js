...
function Drawer({
  ...
  return __jsx("main", {
    className: " fixed overflow-hidden z-10 bg-gray-900 bg-opacity-25 inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-full  " : " transition-all delay-500 opacity-0 translate-x-full  "),
    __self: this,
    __source: {
...
//# sourceMappingURL=0.20b2b1bac6031d639e25.hot-update.js.map