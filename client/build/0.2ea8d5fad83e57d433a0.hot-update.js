...
const CardElementsFunctions = () => {
  ...
  const getDocumentColors = () => {
    const stringifyData = JSON.stringify(cardData).toString();
    console.log({
      stringifyData,
      REGEXMATCH: stringifyData.match(_utils_defaults__WEBPACK_IMPORTED_MODULE_4__["hex_regex"])
    });
    return stringifyData.match(_utils_defaults__WEBPACK_IMPORTED_MODULE_4__["hex_regex"]);
  };
...
//# sourceMappingURL=0.2ea8d5fad83e57d433a0.hot-update.js.map