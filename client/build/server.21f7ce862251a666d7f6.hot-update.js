...
function Example() {
  return __jsx("div", {
    ...
    autoComplete: "email",
    required: true,
    className: "appearance-none rounded-none border-4 relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo500 focus:border-indigo500 focus:z-10 sm:text-sm",
...
//# sourceMappingURL=server.21f7ce862251a666d7f6.hot-update.js.map