...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: " flex gap-6 mt-6 px-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 95,
    ...
    className: "bg-lightindigo text-indigo700 rounded-md px-2 py-1 h-10",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96,
...
//# sourceMappingURL=1.85bbf0b9b6a5eb76b04d.hot-update.js.map