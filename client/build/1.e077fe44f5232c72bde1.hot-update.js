...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "inline-flex justify-center w-full rounded-md border border-bordercolor shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500",
    id: "menu-button",
    "aria-expanded": "true",
    "aria-haspopup": "true",
    __self: undefined,
...
//# sourceMappingURL=1.e077fe44f5232c72bde1.hot-update.js.map