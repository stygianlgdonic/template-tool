...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "fixed inset-0 flex items-center z-50 justify-center overflow-x-hidden overflow-y-auto outline-none  focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68,
    ...
    className: "fixed inset-0 z-0 opacity-25 bg-black ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 160,
...
//# sourceMappingURL=1.11667c53d88f37fdd2e9.hot-update.js.map