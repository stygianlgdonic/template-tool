...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    className: "h-full fixed flex flex-col bg-gray-50 ",
    __self: undefined,
    __source: {
    ...
    className: "flex justify-start ml-6 items-start mx-auto mt-6 align-middle mb-8 w-full bg-green",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
    ...
    className: "flex flex-col justify-start text-left items-start pl-6 leading-10 text-lightGray  w-full bg-yellow ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-full pr-8 hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
    ...
    className: "flex hover:bg-lightindigo hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37,
    ...
    className: "flex hover:bg-lightindigo hover:rounded-md border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
    ...
    className: "flex hover:bg-lightindigo hover:rounded-md border-0 rounded-lg pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 79,
...
//# sourceMappingURL=1.d59a0f22ab2aa32fbaad.hot-update.js.map