...
const AddBackgroundImage = () => {
  ...
  return __jsx("div", {
    ...
    className: "relative top-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
    ...
    className: "absolute w-auto max-w-3xl mx-auto my-6",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63,
...
//# sourceMappingURL=0.c394fce60497778a20f1.hot-update.js.map