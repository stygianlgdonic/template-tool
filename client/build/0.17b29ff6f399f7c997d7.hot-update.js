...
const ElementHeader = ({
  ...
  const getSelectedElementimgurl = () => {
    if (selectedId) {
      const selectedShape = cardData.elements.find(item => item.patternImageUrl === undefined);
      console.log("zinda");
...
//# sourceMappingURL=0.17b29ff6f399f7c997d7.hot-update.js.map