...
const UText = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Text"], _extends({
    ...
    style: {
      ...
      transform: `rotateY(${(_textNode$current4 = textNode.current) === null || _textNode$current4 === void 0 ? void 0 : (_textNode$current4$at = _textNode$current4.attrs) === null || _textNode$current4$at === void 0 ? void 0 : _textNode$current4$at.rotation}deg)`
    },
...
//# sourceMappingURL=0.4ddb4f95133f0dc9ca5b.hot-update.js.map