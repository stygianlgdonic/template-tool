...
const TextSelector = () => {
  ...
  return __jsx("div", {
    ...
    className: "mt-6 w-full flex flex-col  justify-start bg-red",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23,
    ...
    className: "text-3xl leading-none font-normal flex justify-starttext-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
    ...
    className: "text-xl leading-none font-normal text-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
    ...
    className: "text-lg leading-none font-normal text-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
...
//# sourceMappingURL=0.811551081fbeca567519.hot-update.js.map