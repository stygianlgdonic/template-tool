...
const SelectSocialMediaTemplateModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: " bg-green float-right  ml-auto text-3xl font-semibold leading-none text-black border-0 outline-none  focus:outline-none",
    onClick: closeModal,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "block w-6  text-2xl text-black bg-white outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
...
//# sourceMappingURL=1.a121ab766a16db0cb98d.hot-update.js.map