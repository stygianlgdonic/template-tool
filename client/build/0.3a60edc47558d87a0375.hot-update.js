...
const BackgroundColor = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: " w-28 h-10 border-1 text-center border-bordercolor text-gradientColor inline-flex  px-3 py-1.5 border border-transparent text-xs font-medium rounded-sm shadow-sm bg-jacksonsGray hover:bg-jacksonsGray focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jacksonsGray",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=0.3a60edc47558d87a0375.hot-update.js.map