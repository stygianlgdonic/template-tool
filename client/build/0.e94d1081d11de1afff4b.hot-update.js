...
const BackgroundColor = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: " w-28 h-10 text-gradientColor inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-full shadow-sm bg-indigo600 hover:bg-indigo700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
...
//# sourceMappingURL=0.e94d1081d11de1afff4b.hot-update.js.map