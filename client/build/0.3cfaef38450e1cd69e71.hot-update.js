...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex items-center  hover:bg-rightbackgroundcolor focus:bg-rightbackgroundcolor w-full hover:rounded-lg border-0 rounded-sm  pl-5 h-10 mb-1",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12,
...
//# sourceMappingURL=0.3cfaef38450e1cd69e71.hot-update.js.map