...
const FontStyletool = () => {
  ...
  const handleTextHollow = () => {
    setCardData(prev => {
      const updatedText = _objectSpread(_objectSpread({}, prev.elements.find(item => item.id === selectedId)), _utils_defaults__WEBPACK_IMPORTED_MODULE_2__["defaultTextHollow"]);
    });
  };
...
//# sourceMappingURL=0.168220c423fc82ef9fd9.hot-update.js.map