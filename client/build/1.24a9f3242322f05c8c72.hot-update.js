...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: dashboardnavigator === "home" ? "w-full bg-lightindigo pl-2" : "w-full ",
    onClick: () => setDashboardnavigator('home'),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
    ...
    className: "flex hover:bg-lightindigo hover:rounded-lg  border-0  w-60 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
...
//# sourceMappingURL=1.24a9f3242322f05c8c72.hot-update.js.map