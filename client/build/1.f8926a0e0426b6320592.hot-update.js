...
const SelectSocialMediaTemplateModal = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    className: "flex items-center ml-auto mr-2 text-sm font-semibold leading-none text-black rounded-full outline-none focus:outline-none" // onClick={() => setShowModal(false)}
    ,
    onClick: closeModal,
    __self: undefined,
    __source: {
...
//# sourceMappingURL=1.f8926a0e0426b6320592.hot-update.js.map