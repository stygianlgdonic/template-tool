...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative flex flex-row  items-center w-32 py-2 pl-3 pr-10 text-left border-2 rounded-lg shadow-sm cursor-default h-10 border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
...
//# sourceMappingURL=0.08f747583518e9bf5a95.hot-update.js.map