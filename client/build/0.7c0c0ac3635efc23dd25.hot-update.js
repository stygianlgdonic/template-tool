...
const FontStyletool = () => {
  ...
  return __jsx("div", {
    ...
    id: "example4",
    className: "w-24 border-2 border-bordercolor flex items-center h-24 rounded-md justify-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 76,
    ...
    className: "glow w-24 border-2 border-bordercolor flex items-center h-24 rounded-md justify-center",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 79,
    ...
    className: "glitch-text w-24 border-2 border-bordercolor flex items-center h-24 rounded-md justify-center ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80,
...
//# sourceMappingURL=0.7c0c0ac3635efc23dd25.hot-update.js.map