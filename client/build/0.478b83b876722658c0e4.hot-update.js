...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "block w-full h-4 truncate  hover:bg-indigo600   bg-elementColor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 71,
    ...
    className: "block w-full h-2 mt-2 font-normal truncate hover:bg-indigo600    bg-elementColor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 77,
    ...
    className: "block w-full h-1 mt-2 font-normal truncate hover:bg-indigo600    bg-elementColor",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 83,
    ...
    className: "flex w-full border border-bordercolor hover:text-white rounded justify-center hover:bg-lightindigo",
    ...
    className: "w-10 h-10 rounded-md bg-indigo600 hover:ring-2 ring-black",
...
//# sourceMappingURL=0.478b83b876722658c0e4.hot-update.js.map