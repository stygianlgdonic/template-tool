...
const AddBackgroundImage = () => {
  ...
  return __jsx("div", {
    className: "absolute flex flex-col justify-center w-full p-6 ",
    __self: undefined,
    __source: {
    ...
    className: "relative z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none top-1 focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
...
//# sourceMappingURL=0.19c22c9006768be3287f.hot-update.js.map