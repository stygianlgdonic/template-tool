...
function Example() {
  return __jsx("div", {
    className: "min-h-screen flex items-center justify-center bg-gray95 py-12 px-4 sm:px-6 lg:px-8",
    __self: this,
    __source: {
...
//# sourceMappingURL=server.072cfacca45d6ffdac9a.hot-update.js.map