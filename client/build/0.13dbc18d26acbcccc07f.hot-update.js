...
const TransformerComponent = ({
  ...
  , {
    ...
    style: {
      marginLeft: ((_$tr$current = $tr.current) === null || _$tr$current === void 0 ? void 0 : (_$tr$current$findOne = _$tr$current.findOne('.top-right')) === null || _$tr$current$findOne === void 0 ? void 0 : _$tr$current$findOne.position().x) - ((_editIconRef$current2 = editIconRef.current) === null || _editIconRef$current2 === void 0 ? void 0 : (_editIconRef$current3 = _editIconRef$current2.getBoundingClientRect()) === null || _editIconRef$current3 === void 0 ? void 0 : _editIconRef$current3.width),
      marginBottom: 5
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=0.13dbc18d26acbcccc07f.hot-update.js.map