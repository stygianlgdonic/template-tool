...
const ElementHeader = () => {
  ...
  const {
    0: openDropDown,
    1: setopenDropDown
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(true); // !!state?false:true;
  ...
  return __jsx("div", {
    ...
    onClick: () => setOpen(openDropDown ? false : true),
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=0.ef95347d0f0cba2095b2.hot-update.js.map