...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "tooltip p-1 rounded bg-red-500 sm:bg-yellow-400 md:bg-blue-500 lg:bg-green-700",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 78,
  ...
  }, "Some Nice Tooltip Text"), "Different depending on device"), __jsx("button", {
    className: "w-full",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.1cf0881bf83cd0ad9f4c.hot-update.js.map