...
const TransformModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, " ", __jsx("div", {
    className: "absolute top-0 left-0 z-50 flex items-center justify-center h-full overflow-x-hidden overflow-y-auto outline-none bg-indigo600 inherit focus:outline-none",
    __self: undefined,
    __source: {
    ...
    ref: myRef,
    className: "relative z-50 max-w-4xl mx-auto my-6 rounded-md bg-red",
    style: {
      height: "100vh"
    },
    __self: undefined,
...
//# sourceMappingURL=0.f04ef53149a44bb8e014.hot-update.js.map