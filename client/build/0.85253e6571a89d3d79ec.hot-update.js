...
const UText = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Text"], _extends({
    ...
    onTransform: e => {
      var _$tr$current, _e$target$attrs;

      console.log({
        asasas: (_$tr$current = $tr.current) === null || _$tr$current === void 0 ? void 0 : _$tr$current.rotateAnchorOffset()
      });
      ...
      textAreaRef.current.style.transformOrigin = "center center";
...
//# sourceMappingURL=0.85253e6571a89d3d79ec.hot-update.js.map