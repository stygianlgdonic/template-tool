...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute z-10 py-1 mt-1 overflow-auto text-base bg-black rounded-md shadow-lg w-52 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
...
//# sourceMappingURL=0.c7bb33fa4474cdb1880f.hot-update.js.map