...
const MainStage = ({
  ...
  const [showModaltranform, setshowModaltranform] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(false);
  const [searchResultTop, setSearchResultTop] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(0);
  const Konva = window.Konva;
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useLayoutEffect(() => {
    const updatePosition = () => {
      var _$tr$current;

      setSearchResultTop((_$tr$current = $tr.current) === null || _$tr$current === void 0 ? void 0 : _$tr$current.getBoundingClientRect().bottom);
    };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    !!selectedId ? toggleFloatingSearchResults(true) : toggleFloatingSearchResults(false);
  }, [selectedId]);

  const toggleFloatingSearchResults = showRes => {
    setshowModaltranform(showRes);
  };
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, showModaltranform && __jsx("div", {
    className: "searchresults searchresultsfloat",
    style: {
      top: searchResultTop
    },
    __self: undefined,
...
//# sourceMappingURL=0.4da13d8d6615ff893edd.hot-update.js.map