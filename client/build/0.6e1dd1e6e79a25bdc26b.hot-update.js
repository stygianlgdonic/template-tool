...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: " mt-6 flex justify-end w-9/12 relative  items-center group mx-auto",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 69,
    ...
    className: "absolute bottom-0  flex-col items-center hidden flex mb-6 group-hover:flex",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
...
//# sourceMappingURL=0.6e1dd1e6e79a25bdc26b.hot-update.js.map