...
const MainStage = ({
  ...
  const getLineGuideStops = skipShape => {
    ...
    $stage.current.find(".object").forEach(guideItem => {
      ...
      const isSelected = trNodes === null || trNodes === void 0 ? void 0 : trNodes.some(node => node.attrs.id === guideItem.attrs.id);
      console.log({
        isSelected: $tr === null || $tr === void 0 ? void 0 : $tr.current
      });
...
//# sourceMappingURL=0.dcc6bcc922b4c66b38a2.hot-update.js.map