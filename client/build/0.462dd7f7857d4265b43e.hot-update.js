...
const Stickers = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-row flex-grow  gap-4 h-28  w-56 overflow-x-scroll z-10 no-scrollbar flex-shrink-0  bg-yellow  relative",
    ref: contentWrapper,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: " h-28 z-50 -ml-12 bg-gradient-to-r w-12 from-white  bg-opacity-50 to-transparent",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62,
...
//# sourceMappingURL=0.462dd7f7857d4265b43e.hot-update.js.map