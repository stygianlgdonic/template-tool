...
const TransformModal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, " ", __jsx("div", {
    className: "absolute z-50 flex items-center justify-center w-screen h-screen overflow-x-auto overflow-y-auto outline-none bg-indigo600 inherit focus:outline-none",
    __self: undefined,
    __source: {
    ...
    ref: myRef,
    className: "absolute top-0 z-50 mx-auto my-6 bg-white rounded-md ",
    style: {
      height: "90vh"
    },
    __self: undefined,
...
//# sourceMappingURL=0.4624ce0632f6d4f4e587.hot-update.js.map