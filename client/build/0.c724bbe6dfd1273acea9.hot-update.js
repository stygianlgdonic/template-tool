...
const UText = ({
  ...
  const handleTextDblClick = e => {
    textNode.current.hide(); // $tr.current.detach()
  ...
  const handleTextareaKeyDown = e => {
    if (e.keyCode === "Escape") {
      ...
      console.log("$tr.current.visible()", $tr.current.visible());
      textNode.current.show(); // $tr.current.attachTo(textNode.current)
...
//# sourceMappingURL=0.c724bbe6dfd1273acea9.hot-update.js.map