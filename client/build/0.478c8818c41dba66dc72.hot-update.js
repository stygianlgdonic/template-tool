...
const ElementHeader = () => {
  ...
  return __jsx("div", {
    ...
    className: " absolute flex align-bottom w-40 h-12 items-center bg-white rounded-lg px-4 justify-center pt-5 pb-4 overflow-hidden shadow-xl transform transition-all top-28 self-end  ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
...
//# sourceMappingURL=0.478c8818c41dba66dc72.hot-update.js.map