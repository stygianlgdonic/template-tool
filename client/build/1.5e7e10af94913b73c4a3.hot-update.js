...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex flex-col justify-start text-left items-start px-2 leading-10 text-lightGray  w-full bg-green  ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
    ...
    className: dashboardnavigator === "home" ? "flex hover:bg-lightindigo mr-2 focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo mr-2  w-full hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
...
//# sourceMappingURL=1.5e7e10af94913b73c4a3.hot-update.js.map