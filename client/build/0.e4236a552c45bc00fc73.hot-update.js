...
const BackgroundColor = () => {
  ...
  const [testModal, setTestModal] = react__WEBPACK_IMPORTED_MODULE_0___default.a.useState(false); //   const [backgroundmodal, setBackgroundModal] = React.useState(false);

  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    console.log("Value of showModal", showModal, testModal);
  }, [showModal, testModal]);

  const hhff = () => {
    setShowModal(false);
    setTestModal(true);
    console.log(" iam running", showModal, testModal);
  };
  ...
  }, testModal ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
...
//# sourceMappingURL=0.e4236a552c45bc00fc73.hot-update.js.map