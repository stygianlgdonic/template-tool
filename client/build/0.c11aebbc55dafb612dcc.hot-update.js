...
const SideBarNav = () => {
  ...
  return __jsx("div", {
    ...
    className: "absolute bottom-0  flex-col items-center hidden mb-6 group-hover:flex hover:rounded-md",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73,
    ...
    className: "relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-indigo400 shadow-lg",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74,
...
//# sourceMappingURL=0.c11aebbc55dafb612dcc.hot-update.js.map