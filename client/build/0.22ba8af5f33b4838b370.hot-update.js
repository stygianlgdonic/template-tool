...
function Drawer({
  ...
  return __jsx("main", {
    className: " fixed overflow-hidden z-10 bg-gray-900 bg-opacity-25 inset-y-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0  " : " transition-all delay-500 opacity-0 translate-x-full  "),
    __self: this,
    __source: {
    ...
    className: " w-screen max-w-lg right-0 absolute bg-white h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " + (isOpen ? " translate-x-0 translate-y-14 " : " translate-x-full "),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=0.22ba8af5f33b4838b370.hot-update.js.map