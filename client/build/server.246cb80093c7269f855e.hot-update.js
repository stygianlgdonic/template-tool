...
function Example() {
  ...
  const onhandleSubmit = async e => {
    ...
    if (userObj.password !== userObj.againPassword) {
      ...
      if (res.user.statusCode === 409) {
        sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Error", res.user.message);
      } else {
        sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Success", "Sign up completed").then(() => navigate("/signin"));
      }
    }
  };
...
//# sourceMappingURL=server.246cb80093c7269f855e.hot-update.js.map