...
const CreateEmail = ({
  ...
  return __jsx("div", {
    ...
    className: "relative h-full w-auto my-6 mx-auto max-w-3xl",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54,
    ...
    className: "border-0 rounded-lg shadow-lg relative flex bg-radicalRed h-full flex-col w-full  outline-none focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 56,
...
//# sourceMappingURL=1.9526b193987cce262fb6.hot-update.js.map