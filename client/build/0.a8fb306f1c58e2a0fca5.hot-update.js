...
const ReceipentsLogo = () => {
  ...
  return __jsx("div", {
    ...
    className: "h-10 mt-4 border-dashed rounded-md border-bordercolor bg-red w-60",
    ...
    className: "fixed z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none inset-1 focus:outline-none",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102,
...
//# sourceMappingURL=0.a8fb306f1c58e2a0fca5.hot-update.js.map