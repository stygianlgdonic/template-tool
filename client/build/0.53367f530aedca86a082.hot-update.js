...
const UText = ({
  ...
  var _textNode$current, _textNode$current2;
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(react_konva__WEBPACK_IMPORTED_MODULE_1__["Text"], _extends({
    ...
    style: {
      ...
      outline: "none",
      height: textNode === null || textNode === void 0 ? void 0 : (_textNode$current = textNode.current) === null || _textNode$current === void 0 ? void 0 : _textNode$current.getClientRect().height,
      width: textNode === null || textNode === void 0 ? void 0 : (_textNode$current2 = textNode.current) === null || _textNode$current2 === void 0 ? void 0 : _textNode$current2.getClientRect().width
    },
...
//# sourceMappingURL=0.53367f530aedca86a082.hot-update.js.map