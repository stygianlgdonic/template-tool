...
const TextHeader = () => {
  ...
  return __jsx("div", {
    ...
    type: "button",
    className: "relative flex flex-row  items-center bg-green w-32 py-2 pl-3 pr-10 text-left border-2 rounded-lg shadow-sm cursor-default h-10 border-bordercolor focus:outline-none focus:ring-border focus:ring-gray300 focus:border-gray300 sm:text-sm",
    ...
    className: "bg-red h-9 pr-6 py-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52,
    ...
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
    d: "M0.234315 0.834321C0.546734 0.521901 1.05327 0.521901 1.36569 0.834321L4 3.46864L6.63431 0.834321C6.94673 0.521901 7.45327 0.521901 7.76568 0.834321C8.0781 1.14674 8.0781 1.65327 7.76568 1.96569L4.56569 5.1657C4.25327 5.47812 3.74673 5.47812 3.43431 5.1657L0.234315 1.96569C-0.0781049 1.65327 -0.0781049 1.14674 0.234315 0.834321Z",
    fill: "#9CA3AF",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "absolute z-10 py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 w-full ring-black ring-opacity-5 focus:outline-none sm:text-sm",
    role: "listbox",
    "aria-labelledby": "listbox-label",
    ...
    className: "relative w-full py-2  mr-8 text-gray-900  cursor-default select-none ",
    id: "listbox-option-0",
    role: "option",
    __self: undefined,
    __source: {
...
//# sourceMappingURL=0.62e9483beb6bf1bea796.hot-update.js.map