...
const SelectSocialMediaTemplateModal = ({
  ...
  var _categoryList$data, _templateList$data;
  ...
  }, categoryList === null || categoryList === void 0 ? void 0 : categoryList.error.message), console.log({
    categoryList
  }), categoryList === null || categoryList === void 0 ? void 0 : (_categoryList$data = categoryList.data) === null || _categoryList$data === void 0 ? void 0 : _categoryList$data.map(item => __jsx("button", {
  ...
  }, templateList === null || templateList === void 0 ? void 0 : templateList.error.message), templateList === null || templateList === void 0 ? void 0 : (_templateList$data = templateList.data) === null || _templateList$data === void 0 ? void 0 : _templateList$data.map((item, index) => {
    return __jsx("button", {
      key: index,
...
//# sourceMappingURL=1.1e5ce0afa3aff160b722.hot-update.js.map