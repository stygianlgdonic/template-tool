...
const TransformerComponent = ({
  ...
  var _$tr$current, _$tr$current$findOne, _editIconRef$current, _editIconRef$current$, _$tr$current2, _$tr$current2$findOne, _$tr$current3, _$tr$current3$findOne, _editIconRef$current2, _editIconRef$current3;
  ...
  , {
    ...
    style: {
      ...
      top: ((_$tr$current2 = $tr.current) === null || _$tr$current2 === void 0 ? void 0 : (_$tr$current2$findOne = _$tr$current2.findOne('.middle-left')) === null || _$tr$current2$findOne === void 0 ? void 0 : _$tr$current2$findOne.position().y) - 5
    },
    ...
    style: {
      position: "absolute",
      left: ((_$tr$current3 = $tr.current) === null || _$tr$current3 === void 0 ? void 0 : (_$tr$current3$findOne = _$tr$current3.findOne('.top-right')) === null || _$tr$current3$findOne === void 0 ? void 0 : _$tr$current3$findOne.position().x) - ((_editIconRef$current2 = editIconRef.current) === null || _editIconRef$current2 === void 0 ? void 0 : (_editIconRef$current3 = _editIconRef$current2.getBoundingClientRect()) === null || _editIconRef$current3 === void 0 ? void 0 : _editIconRef$current3.width)
    },
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=0.b87ca9af06ce0c5d0f0f.hot-update.js.map