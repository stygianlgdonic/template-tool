...
const LeftSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: "flex hover:bg-lightindigo  focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
...
//# sourceMappingURL=1.40f92ff052ccf1db81ae.hot-update.js.map