...
const RightSidebar = () => {
  ...
  return __jsx("div", {
    ...
    className: dashboardnavigator === "home" ? " h-screen flex items-center justify-center  bg-red " : "hidden",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46,
    ...
    className: "flex flex-col items-center  h-screen bg-green justify-center  ",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=1.95bb99e8ad7954f419fc.hot-update.js.map