...
export const stageDimensions = { width: 500, height: 500 }
...
export const defaultRect = { name: "object", x: 150, y: 150, width: 100, stroke: "#000000", strokeWidth: 0, height: 100, fill: '#D1D5DB', draggable: true, type: "rectangle" }
export const defaultRoundedRect = { name: "object", x: 150, y: 250, width: 100, stroke: "#000000", strokeWidth: 0, height: 100, cornerRadius: 10, fill: '#D1D5DB', draggable: true, type: "rectangle" }
export const defaultCircle = { name: "object", x: 200, y: 100, radius: 50, stroke: "#000000", strokeWidth: 0, fill: '#D1D5DB', draggable: true, type: "circle" }
export const defaultPolygon = { name: "object", x: 100, y: 150, sides: 6, stroke: "#000000", strokeWidth: 0, radius: 70, fill: '#D1D5DB', type: "polygon" }
export const defaultTriangle = { name: "object", x: 20, y: 200, stroke: "#000000", strokeWidth: 0, fill: "#D1D5DB", points: [0, 100, 50, 0, 100, 100], tension: 0, closed: true, type: "line", }
export const defaultTextBox = { name: "object", text: 'New text', x: 150, y: 200, fontSize: fontSizeArray[0].size, fontFamily: googleFontsList[0], draggable: true, width: 200, type: "text", fill: "#000000" }
export const defaultTextNoEffect = { fill: "black", stroke: "", shadowEnabled: false, shadowBlur: 0, shadowColor: "", shadowOffset: { x: 0, y: 0 } }
export const defaultTextHollow = { fill: "white", stroke: "black", shadowColor: "", shadowEnabled: false, shadowBlur: 0, shadowOffset: { x: 0, y: 0 } };
export const defaultTextLift = { fill: "black", shadowEnabled: true, shadowBlur: 10, stroke: "", shadowColor: "", shadowOffset: { x: 0, y: 0 } };
export const defaultTextShadow = { fill: "black", shadowEnabled: true, shadowColor: "grey", shadowOffset: { x: 2, y: 2 }, shadowBlur: 2, stroke: "" };
export const defaultTextSplice = { shadowColor: "grey", shadowOffset: { x: 2, y: 2 }, shadowBlur: 5, fill: "white", stroke: "black", shadowEnabled: true };
export const defaultTextGlitch = { fill: "darkerblue", shadowEnabled: true, shadowColor: "magenta", shadowOffset: { x: -2, y: -2 }, shadowBlur: 2, stroke: "" };
export const defaultTextNeon = { fill: "magenta", shadowColor: "magenta", shadowEnabled: true, shadowBlur: 10, shadowOffset: { x: -2, y: -2 } };

export const ORIGINAL_SVG_mailicon = `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_imageicon = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_eyeicon = `<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_impressionicon = `<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_arrow_upicon = `<svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
export const ORIGINAL_SVG_editicon = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_attachementicon = `<svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_deleteicon = `<svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ORIGINAL_SVG_bluedoticon = `<svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="5.5" cy="5.5" r="5.5" fill="#4F46E5"/>
</svg>
`;
export const ORIGINAL_SVG_greendoticon = `<svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
