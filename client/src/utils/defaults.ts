...
export const defaultTextBox = { name: "object", text: 'New text', x: 150, y: 200, fontSize: 20, fontFamily: googleFontsList[0], draggable: true, width: 200, type: "text", fill: "#000000" }
