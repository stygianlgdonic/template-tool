    ...
    return (
        <div className="flex flex-row items-center justify-center gap-4 px-6 h-full ">
            ...
            <div className="z-50 flex items-center">
                ...
                <div className="py-4 ml-6 border-r-2 border-bordercolor"></div>
                <div className="ml-6 text-lg italic font-bold h-10  rounded-md text-black hover:bg-lightindigo  px-2">
                    <button className="mt-1" onClick={() => setDesignToolnavigator('effecttool')} >Effects</button>
                    {/* <Range
                        step={1}
                        min={0}
                        max={75}
