...
const ElementHeader: React.FC = (): JSX.Element => {
    ...
    return (
        <div className="flex justify-between w-11/12 ml-14 h-full " style={{ paddingBottom: "5px" }}>
            <div className="flex" >
                <button className="w-6 h-10 " onClick={() => setDesignToolnavigator('fonttool')}>
                    <div className="h-full bg-radicalRed w-10 rounded-md"></div>
                </button>
                {/* ////////////////////// */}
                <div className="ml-10 ">
                    <div
