        ...
        <div className=" flex   flex-col  w-full p-6 ">
            ...
            <div className="mt-6 w-full flex flex-col  justify-start ">
                <button
                    ...
                    className="text-3xl leading-none font-normal flex justify-start text-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full"><p>Heading 1</p></button>
                <button
                    onClick={() => handleTextAdd("Sub header")}
                    className="text-xl leading-none font-normal flex justify-start text-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full"><p>Sub header</p></button>
                <button
                    onClick={() => handleTextAdd("body text")}
                    className="text-lg leading-none font-normal flex justify-start text-gray94 mb-2 hover:bg-lightindigo px-4 rounded w-full"><p>Body text</p></button>
            </div>
