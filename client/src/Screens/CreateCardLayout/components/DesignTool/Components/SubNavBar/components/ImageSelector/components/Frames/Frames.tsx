        ...
        <div className=" flex   flex-col  w-full ">
            ...
            <div className="flex w-full flex-col">
                ...
                <div className=" w-full gap-4 grid grid-cols-4     mt-6 ">
                    <div>
                        <button onClick={() => handleAddNewCircle({ ...defaultCircle, fill: undefined, patternImageUrl: "https://ca.slack-edge.com/T0100HQFETG-U01PVA68RDE-90fc2d0a43dd-72" })}>
                            <img src={image2} className="w-16 h-18" />
                        </button>
                    </div>
                    <div>
                        <button onClick={() => handleAddNewRect({ ...defaultRect, fill: undefined, patternImageUrl: "https://ca.slack-edge.com/T0100HQFETG-U01PVA68RDE-90fc2d0a43dd-72" })}>
                            <img src={image3} className="w-16 h-18" />
                        </button>
                    </div>
                    <div>
                        <button onClick={() => handleAddNewPolygon({ ...defaultPolygon, fill: undefined, patternImageUrl: "https://ca.slack-edge.com/T0100HQFETG-U01PVA68RDE-90fc2d0a43dd-72" })}>
                            <img src={image1} className="w-16 h-18" />
                        </button>
                    </div>
                    <div>
                        <button onClick={() => handleAddNewTrianlge({ ...defaultTriangle, fill: undefined, patternImageUrl: "https://ca.slack-edge.com/T0100HQFETG-U01PVA68RDE-90fc2d0a43dd-72" })}>
