    ...
    return (
        <div className="h-full fixed flex  flex-col w-2/12 ">
            ...
            <div className="flex flex-col justify-start text-left items-start leading-10  px-2 text-lightGray w-full  h-full mt-6 ">
                ...
                <button className="w-full focus:bg-rightbackgroundcolor h-10" onClick={() => setDesignToolnavigator('images')}>
                ...
                <button className="w-full focus:bg-rightbackgroundcolor h-10" onClick={() => setDesignToolnavigator('background')}>
                    <div className="flex items-center hover:bg-rightbackgroundcolor w-full hover:rounded-sm border-0 rounded-sm  pl-5 mb-1">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="w-full focus:bg-rightbackgroundcolor h-10" onClick={() => setDesignToolnavigator('logo')}>
