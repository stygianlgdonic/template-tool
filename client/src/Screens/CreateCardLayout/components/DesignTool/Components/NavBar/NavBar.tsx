    ...
    return (
        <div className="h-full fixed flex  flex-col w-2/12 " >
            ...
            <div className="flex flex-col justify-start text-left items-start leading-10  px-2 text-lightGray w-full  h-full mt-6 ">
                <button className={designToolnavigator === 'element' ? "w-full   bg-rightbackgroundcolor  h-10" : "w-full h-10 "} onClick={() => setDesignToolnavigator('element')}>
                    <div className="flex items-center  hover:bg-lightrightbackgroundcolor  w-full hover:rounded-lg border-0 rounded-sm  pl-5 h-10 mb-1">
                ...
                <button className={designToolnavigator === "text" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => setDesignToolnavigator('text')}>
                    <div className="flex items-center hover:bg-lightrightbackgroundcolor w-full hover:rounded-lg border-0 rounded-sm  pl-5 mb-1">
                ...
                <button className={designToolnavigator === "images" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => setDesignToolnavigator('images')}>
                ...
                <button className={designToolnavigator === "background" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => setDesignToolnavigator('background')}>
                    <div className="flex items-center hover:bg-lightrightbackgroundcolor w-full hover:rounded-sm border-0 rounded-sm  pl-5 mb-1">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className={designToolnavigator === "logo" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => setDesignToolnavigator('logo')}>
