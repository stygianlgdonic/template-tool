    ...
    return (
        <div className="h-full fixed flex  flex-col w-2/12 " >
            ...
            <div className="flex flex-col justify-start text-left items-start leading-10  px-2 text-lightGray w-full  h-full mt-6 ">
                <button className={designToolState.navbar_selection === 'element' ? "w-full   bg-rightbackgroundcolor  h-10" : "w-full h-10 "} onClick={() => designToolDispatch({ type: 'element' })}>
                ...
                <button className={designToolState.navbar_selection === "text" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => designToolDispatch({ type: 'text' })}>
                ...
                <button className={designToolState.navbar_selection === "images" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => designToolDispatch({ type: 'images' })}>
                ...
                <button className={designToolState.navbar_selection === "background" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => designToolDispatch({ type: 'background' })}>
                    <div className="flex items-center hover:bg-rightbackgroundcolor w-full hover:rounded-sm border-0 rounded-sm  pl-5 mb-1">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className={designToolState.navbar_selection === "logo" ? "w-full bg-rightbackgroundcolor h-10" : "w-full  h-10"} onClick={() => designToolDispatch({ type: 'logo' })}>
