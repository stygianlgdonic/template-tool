  ...
  return (
    <div className="flex flex-col w-full h-full px-4">
      <div className="w-full ">
        <h1 className="text-xl font-bold mt-14 ">Receipents logo</h1>
      </div>
      <div>
        <p className="mt-4 text-sm text-gray95">
          Add a dynamic logo to your personalized image
        </p>
      </div>
      <div>
        <button
