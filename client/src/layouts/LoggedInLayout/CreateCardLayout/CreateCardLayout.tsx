    ...
    return (
        <div className=" overflow-hidden">
            ...
            <div className="relative" style={{ height: '88vh' }}>
                ...
                <DesignTool />
                <div className="w-14 absolute h-full right-0 top-0 bg-white" style={{ paddingTop: '54px' }}>
                    <div className="w-6  "></div>
                    <button onClick={() => setOpen(!open)} className="flex  bg-canvasbgcolor items-center h-full pt-10  " style={{ marginTop: '7px' }}>
                        <div className="w-10 h-20 -right-6 relative  bg-white rounded-r rounded-full   flex items-center pl-1">
