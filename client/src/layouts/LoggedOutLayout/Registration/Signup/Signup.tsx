...
export default function Example() {
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen py-12 bg-gray50 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img
          ...
          alt="Workflow"
        />
        <h2 className="mt-6 text-3xl font-extrabold text-center text-gray-900">Sign up to get the full experience</h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" action="#" onSubmit={onhandleSubmit} method="POST">
            <div>
