            ...
            <div>
                ...
                <div className="flex flex-col justify-start text-left items-start px-2 leading-10 text-lightGray   mx-1" style={{ width: '33.5vh' }}>
                    ...
                    <button className=" w-full  " onClick={() => { setDashboardnavigator('home'); setSidebarnavigator('') }}>
                        ...
                        <div className={dashboardnavigator === "home" ? "flex hover:bg-indigo100  mr-2 focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-indigo100   focus:bg-lightindigo mr-2  w-full hover:rounded-lg border-0 rounded-md pl-2"}  >
                    ...
                    <button className="w-full" onClick={() => setDashboardnavigator('images')}>
                        ...
                        <div className={dashboardnavigator === "images" ? "flex hover:bg-lightindigo  focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo  w-full hover:rounded-lg border-0 rounded-md pl-2"} >
                            <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink className="w-full  h-10" to="/signin">
                        <button className="w-full">
                            ...
                            <div className="flex hover:bg-lightindigo hover:rounded-md border-0  w-full rounded-md pl-2">
                                ...
                                <button onClick={userAuthenticationService.logoutUser} className="text-lightGray font-medium">Logout</button>
                            </div>
                        </button>
                    </NavLink>
