...
const LeftSidebar: React.FC = () => {
    ...
    return (
        <div className="h-full fixed flex flex-col  ">
            ...
            <div className="flex flex-col justify-start text-left items-start ml-2 leading-10 text-lightGray  w-full  ">

                <button className=" w-full  " onClick={() => { setDashboardnavigator('home'); setSidebarnavigator('') }}>

                    <div className={dashboardnavigator === "home" ? "flex hover:bg-lightindigo  focus:bg-lightindigo  w-60 hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo  w-60 hover:rounded-lg border-0 rounded-md pl-2"}  >
                        ...
                        <p className="text-lightGray font-medium">Home</p>
                    </div>
                </button>

                <button className="w-full" onClick={() => setDashboardnavigator('images')}>

                    <div className={dashboardnavigator === "images" ? "flex hover:bg-lightindigo  focus:bg-lightindigo  w-60 hover:rounded-lg border-0 rounded-md pl-2 bg-lightindigo" : "flex hover:bg-lightindigo  focus:bg-lightindigo  w-60 hover:rounded-lg border-0 rounded-md pl-2"} >
                        <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="w-full">
                    ...
                    <div className="flex hover:bg-lightindigo hover:rounded-md border-0  w-60 rounded-md pl-2">
                        <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NavLink className="w-full  h-10" to="/createcard">
                    <button className="w-full">
