...
const LeftSidebar: React.FC = () => {
    ...
    return (
        <div className="h-full fixed flex flex-col w-full">
            ...
            <div className="flex flex-col justify-start text-left items-start ml-6 leading-10 text-lightGray w-1/6">

                <button className=" w-full  ">

                    <div className="flex hover:bg-lightindigo  focus:bg-lightindigo  w-5/6 hover:rounded-lg border-0 rounded-md pl-2">
                ...
                <NavLink className="w-full  h-10" to="/createcard">
                    <button className="w-full">
                        ...
                        <div className="flex hover:bg-lightindigo w-5/6 hover:rounded-lg border-0 rounded-md pl-2">
                            <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="w-full">
                    ...
                    <div className="flex hover:bg-lightindigo w-5/6 hover:rounded-md border-0 rounded-md pl-2">
                        <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="w-full">
                    ...
                    <div className="flex hover:bg-lightindigo w-5/6 hover:rounded-md border-0 rounded-lg pl-2">
                        <svg className="mr-2 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
